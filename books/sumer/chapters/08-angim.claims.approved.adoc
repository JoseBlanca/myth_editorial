...
The composition is catalogued as ETCSL 1.6.1 and survives on Old Babylonian manuscripts; also attested in an Akkadian bilingual version (only the Sumerian text is in scope).footnote:[ETCSL 1.6.1, bibliography.]
// EVIDENCE: source_id=etcsl ; loc=1.6.1, bibliography

Substantially preserved at 208 lines.footnote:[ETCSL 1.6.1, composite text.]
...
The composition known as "Angim" (from its incipit, conventionally rendered "Angim dimma," meaning "on a day that was") is catalogued as ETCSL 1.6.1 and extends to 208 lines.footnote:[ETCSL 1.6.1, composite text, lines 1–206.]
...
The composition complements Lugal-e by addressing what the longer text leaves implicit: the problem of what happens when the warrior returns home still burning with battle-fury.footnote:[Black et al. 2004, p. 192.]
// EVIDENCE: source_id=jacobsen-1987 ; loc=pp. 233–234
