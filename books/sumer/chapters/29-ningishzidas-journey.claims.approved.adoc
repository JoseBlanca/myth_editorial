...
The composition is catalogued as ETCSL 1.7.3 and survives on six or more manuscripts from multiple sites, including UET 6 23 from Ur (not exclusively Nippur).footnote:[ETCSL 1.7.3, bibliography.]
// EVIDENCE: source_id=etcsl ; loc=1.7.3, bibliography

Approximately 90 lines of largely continuous narrative with minor localised lacunae.footnote:[ETCSL 1.7.3, composite text.]
