...
The composition is catalogued as ETCSL 1.4.1 and survives on over 50 tablets and fragments from multiple sites, including CBS 12638 and HS 1480, making it the most extensively attested Sumerian literary composition.footnote:[ETCSL 1.4.1, bibliography.]
// EVIDENCE: source_id=etcsl ; loc=1.4.1, bibliography

The text scholars read is a composite assembled from these many overlapping witnesses; no single tablet preserves the complete narrative.footnote:[ETCSL 1.4.1, composite text.]
// EVIDENCE: source_id=etcsl ; loc=1.4.1, composite text

The present retelling follows the ETCSL composite text, supplemented by Black et al. 2004, pp. 52–62; Jacobsen 1987, pp. 205–232; Sladek 1974.footnote:[Black et al. 2004, pp. 52–62; Jacobsen 1987, pp. 205–232; Sladek 1974.]
// EVIDENCE: source_id=etcsl ; loc=1.4.1, composite text
