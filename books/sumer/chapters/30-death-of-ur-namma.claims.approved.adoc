...
The composition is catalogued as ETCSL 2.4.1.1 and survives on Old Babylonian tablets from Nippur; included per scope policy for its substantial underworld narrative.footnote:[ETCSL 2.4.1.1, bibliography.]
// EVIDENCE: source_id=etcsl ; loc=2.4.1.1, bibliography

Reconstructed from several tablets; 242 lines in the composite text.footnote:[ETCSL 2.4.1.1, composite text.]
// EVIDENCE: source_id=etcsl ; loc=2.4.1.1, composite text

The present retelling follows the ETCSL composite text, supplemented by Flückiger-Hawker 1999 (critical edition).footnote:[Flückiger-Hawker 1999 (critical edition).]
// EVIDENCE: source_id=etcsl ; loc=2.4.1.1, composite text
