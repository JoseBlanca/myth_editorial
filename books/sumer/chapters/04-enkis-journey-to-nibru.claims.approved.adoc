...
The composition is catalogued as ETCSL 1.1.4 and survives on 62 manuscript witnesses listed in the ETCSL bibliography, making it one of the most widely copied compositions in the curriculum.footnote:[ETCSL 1.1.4, bibliography.]
// EVIDENCE: source_id=etcsl ; loc=1.1.4, bibliography

Generally well-preserved; the text is reconstructed from substantial fragments with a clear narrative sequence.footnote:[ETCSL 1.1.4, composite text.]
