...
# Input file: chapters/06-enlil-and-sud.claims.adoc

```
== Enlil and Sud: The Courtship in Shuruppag — Claims
...
The text presents the orderly, sanctioned courtship of Enlil and Sud — a narrative that contrasts sharply with the transgressive encounter narrated in "Enlil and Ninlil" (ETCSL 1.2.1, chapter 5).footnote:[Black et al. 2004, pp. 108–115; Jacobsen 1987, pp. 167–168.]
// EVIDENCE: source_id=black-2004 ; loc=pp. 108–115

=== Enlil encounters Sud

Enlil, king of the gods, travels to the city of Shuruppag, an ancient Sumerian city in the southern alluvial plain.footnote:[ETCSL 1.2.2, lines 1–15; Black et al. 2004, p. 108.]
...
The gift catalogue follows the pattern of Sumerian bride-price conventions attested in legal and administrative texts from the same period.footnote:[Black et al. 2004, pp. 108–115 (introduction).]
// EVIDENCE: source_id=black-2004 ; loc=pp. 108–115
...
The composition models the ideal divine marriage protocol that earthly ceremonies reflect, including bride-price, envoy negotiations, maternal consent, and a naming ceremony.footnote:[Black et al. 2004, pp. 108–115.]
// EVIDENCE: source_id=black-2004 ; loc=pp. 108–115

The courtship protocol mirrors attested Sumerian marriage customs, making this text a primary source for reconstructing OB marriage ritual and gender norms in divine narrative.footnote:[ETCSL 1.2.2, commentary; Black et al. 2004, pp. 108–115.]
