...
# Book: chaoskampf
# Generated: 2026-04-30T13:21:32Z
...
# Input file: chapters/26-pariacaca-amaru.claims.approved.adoc
...
Pariacaca himself is, in the manuscript, simultaneously a person (a divine figure born and acting in narrative time), a mountain (the eponymous Pariacaca peak in the Yauyos region of the western Cordillera, a high glaciated massif among the headwaters of multiple drainages of the central Andean cordillera, including the Mantaro and Cañete river systems), and an ancestral wak'a of the Yauyos people of the Huarochirí region, whose ayllus trace their descent from him and from his sons, with this triple identity person-place-ancestor being the cycle's load-bearing cosmographic premise rather than an interpretive overlay.footnote:[Salomon & Urioste 1991, chs. 6 and 8 on Pariacaca's triple identity as person, mountain, and ancestral wak'a of the Yauyos people of the Huarochirí region; on the eponymous Pariacaca peak as a high glaciated massif among the headwaters of the central Andean cordillera with the Mantaro and Cañete river systems among the principal drainages of the wider Yauyos / Huarochirí area (the precise watershed-boundary formulation against Salomon & Urioste 1991's translators' introduction and against a modern Andean hydrographic reference is to be confirmed at chapter-draft); on the ayllu-descent of the Yauyos from Pariacaca and his sons; per glossary 'Pariacaca' first_mention_gloss on Pariacaca as Andean storm-wak'a of the Huarochirí region.]
...
// Checks passed: footnote+evidence-pair (39/39), source_id-whitelist, glossary-discipline, markers-valid
// Fixes applied: FC-01 LOW (unverified, Pariacaca peak watershed detail at line 75 — MODIFY softening per task-instructions option (a): the body-prose claim that the Pariacaca peak sits "on the boundary between the upper drainages of the Mantaro and Cañete rivers" reframed to "in the Yauyos region of the western Cordillera, a high glaciated massif among the headwaters of multiple drainages of the central Andean cordillera, including the Mantaro and Cañete river systems"; the line 75 footnote rewritten to characterise the precise watershed-boundary formulation as one to be confirmed at chapter-draft against Salomon & Urioste 1991's translators' introduction and against a modern Andean hydrographic reference, preserving the geographic claim with reduced specificity. The MODIFY softening matches the task-instructions guidance for LOW-severity hydrographic-detail findings where the auditor has classified the underlying claim as plausible per trained knowledge but not independently verified at verbatim-quote precision; the ACCEPT-as-PASS option (treating the auditor's plausibility-PASS as sufficient at claims stage) was rejected because the original prose's assertive boundary-formulation lacked hedging that the chapter-draft fact-check will need; the REJECT-as-NOTE option (no edit, deferred to chapter-draft) was rejected because the modest softening preserves the claim while flagging the precise pairing for chapter-draft verification, which is more honest about the current state of the geographic source-record.); FC-02 NOTE (Taylor and Dean named in APPROPRIATION-FLAG body text but absent from sources.yaml, plus Bray and MacCormack named in brief special_instructions but absent from both sources.yaml and the body — FLAGGED-ONLY per Ch23 FC-02 precedent: the named-but-flagged pattern is the established pipeline solution for this situation, and the chapter handles it correctly. The body prose at the APPROPRIATION-FLAG marker (line 143) names Taylor (with his Lima IFEA critical edition context) and Dean (on Andean ritual-political imagination) as area specialists supporting the wak'a-succession reading, with the explicit "named in the brief's special_instructions" hedge that registers the gap; no EVIDENCE token routes through Taylor or Dean. Salomon and Urioste already satisfy scope.md §"Appropriation protocol" point 1 (cite at least two area specialists by name in the first factual pass); Taylor and Dean are supplementary area-specialist named-but-flagged per the same precedent. Bray (Tamara Bray, on Inca objects) and MacCormack (Sabine MacCormack, on pre-Columbian Andean religion) are not invoked in the body, consistent with the brief's "as relevant" qualifier on those two. Pipeline-management addition of Taylor (Ritos y tradiciones de Huarochirí, Lima IFEA 1987/2008) and Dean (A Culture of Stone, Duke 2010 ISBN 9780822348023) to sources.yaml is DEFERRED to inventory-audit, where the Andean-studies sub-registry can be expanded systematically rather than entry-by-entry at claims-stage. No prose, EVIDENCE-tag, brief, or sources.yaml edits applied at post-human-normalize for this NOTE; deferred per the Ch23 FC-02 named-but-flagged precedent.).
// Sources.yaml additions: 0 new entries for Ch26 (Taylor and Dean deferred to inventory-audit per FC-02 named-but-flagged disposition). Source count unchanged (61 entries).
// Briefs / governing-document changes: 0 brief edits for Ch26 (no FC-finding required brief-level acknowledgement at this stage — FC-01 watershed softening is body-prose-and-footnote only since the brief does not currently include a watershed-formulation claim, and FC-02 named-but-flagged sources are deferred to inventory-audit).
// Warnings: none. Banned umbrella terms ("chaos-figure", "chaos-monster", "chaos-serpent") not present in body prose, footnotes, markers, or COMPARATIVE-HOOK comments. Glossary discipline holds (Pariacaca, amaru, wak'a, ayllu, khipu, capacocha, Antisuyu, Yauyos, Condorcoto, Chaupiñamca, Huallallo Carhuincho, Huarochirí Manuscript, Códice Chimalpopoca-equivalent context not present, Ávila, Salomon, Urioste, Taylor, Dean in conventional scholarly forms throughout). Forsyth disclaimer wording at line 53-54 verified as correct per Ch23/Ch24-onwards precedent — the single Forsyth EVIDENCE token correctly characterises Forsyth as the long-arc combat-myth typology framing anchor with explicit "not for Andean-content scholarly coverage" disclaimer; no further fix required. APPROPRIATION-FLAG marker at line 143 verified as complete per the four-component checklist (named area specialists; substance of objection; tier implication; C7/C8 forwarding clause; milder-than-Ch23 characterisation) per the auditor's appropriation_flag_check section. Source-overview register: technical-academic per the chapter's related-tier composite-editorial requirements; no register-softening applied since the audit's findings did not flag overview register, and the user-feedback memory's "Source overviews too academic" note is for future books rather than retroactive softening of an already-fact-checked related-tier chapter at post-human-normalize.
```

---

# Input file: briefs/26-pariacaca-amaru.yaml
...
chapter_type: "related (full)"

sources:
  primary:
    - id: salomon-urioste-huarochiri
      loc: "Huarochirí Manuscript chs. 6, 8, 21 (Pariacaca and amaru passages)"
      identifier: "ISBN 9780292730533"

variants:
  classification: composite-editorial
  summary: |
    The Huarochirí Manuscript (c. 1608) is the single primary source. It records multiple
    episodes across chapters 6, 8, and 21 involving Pariacaca's combats with rival wak'as
    and with amaru. The chapter treats these as a cycle rather than a single combat.

summary: |
  The storm-wak'a Pariacaca opposes, defeats, and integrates rival wak'as across the
  Huarochirí landscape. The amaru in these episodes is often a summoned ally-monster of a
  defeated rival — not a primordial chaos, but a figure of wak'a-succession. Salomon,
  Taylor, and Dean read the narrative as wak'a-succession politics rather than
  cosmos-versus-chaos combat.

cultural_relevance:
  centrality: |
    Central within Huarochirí religious tradition (early-colonial Quechua-language
    attestation from an Andean community's own framing); significant as source for
    pre-Columbian Andean religion more broadly.
  function: |
    - Political-theological (wak'a-succession, integration of defeated wak'as into the
      Pariacaca cult)
    - Geographic-cosmogonic (each combat is localized to a specific landscape feature)
    - Ritual-aetiological (some episodes are tied to specific ritual practices)
  cross_cultural_parallels: |
    - Structurally, Pariacaca's integration of defeated wak'as parallels Marduk's
      incorporation of the fifty names at the end of Enūma Eliš — victory consolidates
      rival power-bases rather than eradicating them.
    - The amaru-as-ally-of-rival pattern is distinctive to the Andean material; the amaru
      is not a primordial chaos-monster but a summoned agent.

target_length_words: 4000

special_instructions: |
  Area-specialist citation policy applies: cite Salomon, Urioste, Taylor, Dean, and (as
  relevant) Bray or MacCormack by name in the first factual pass per scope.md
  §"Appropriation protocol". The chapter must open with the Huarochirí Manuscript's own
  framing (Quechua-language early-colonial text, recorded by an Andean community) and only
  then invoke the comparative term "chaoskampf" — and when it does, explicitly flag that
  Andean specialists read the pattern as wak'a-succession rather than chaos-ordering. The
  chapter contributes to Part II C7 (what inversion or not-quite-chaoskampf teaches) and
  C8 (the refusal and the appropriation problem) in limited form; the Pariacaca material
  is a milder case than Nanabozho/Mishipeshu, because the area-specialist reading does
  accommodate some combat-myth framing — just not the chaos-order framing.
```
