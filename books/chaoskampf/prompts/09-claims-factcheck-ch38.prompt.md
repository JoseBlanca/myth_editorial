...
# Book: chaoskampf
# Generated: 2026-05-03T11:28:05Z
...
# Input file: chapters/38-C5-ie-hero-slay-serpent-formula.claims.adoc
...
The Vedic reflex anchoring Watkins's reconstruction is *áhann áhim* — "he slew the serpent" — from Rigveda 1.32.1, the opening line of the principal Indra-Vṛtra hymn: the third-person preterite of the verb *han-* ("to strike, to kill") combined with the accusative-singular of *ahi-* ("serpent") supplies a verb-and-object pairing whose etymological components recur across the IE family in cognate forms.footnote:[Jamison and Brereton 2014, on RV 1.32.1 as the opening line of the principal Indra-Vṛtra hymn and on the *áhann áhim* phrasing; Watkins 1995, ch. 46 (and the broader Part V), on *áhann áhim* as the Vedic reflex closest to the reconstructed Indo-European form; per glossary.yaml on the locked rendering "áhann áhim" with diacritics.]
...
The Vedic case is anchored on Rigveda 1.32, the principal Indra-Vṛtra hymn (fifteen verses), whose opening line — *áhann áhim*, "he slew the serpent" — supplies the formula's most-cited lexical exhibit; the chapter cites RV 1.32 as the working text via Jamison and Brereton 2014, the scholarly-standard English Rigveda, and reads the *áhann áhim* opening as the Vedic instantiation of the verb-and-object pairing that Watkins reconstructs as the formula.footnote:[Jamison and Brereton 2014, on RV 1.32 as the principal Indra-Vṛtra hymn and on the *áhann áhim* opening at 1.32.1; Watkins 1995, ch. 46 (and broader Part V), on the same line as the Vedic reflex anchor.]
// EVIDENCE: source_id=jamison-brereton-2014 ; loc=RV 1.32 (and 1.32.1)
