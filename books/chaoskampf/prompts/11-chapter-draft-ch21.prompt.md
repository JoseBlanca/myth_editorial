...
# Book: chaoskampf
# Generated: 2026-04-29T17:47:05Z
...
# Input file: chapters/21-gonggong.claims.approved.adoc
...
The *Liezi* (列子, "Master Lie"), a heterogeneous Daoist compilation in its received form conventionally dated to the 3rd–4th century CE but drawing on earlier material, supplies a further later witness to the Gonggong / Nüwa cosmogony, presenting the combat-and-repair sequence as a cosmological aetiology within the compilation's broader cosmological-aetiological-and-Daoist register.footnote:[Lewis 2006, *The Flood Myths of Early China*, chs. 2–3 on the *Liezi* as a later-but-load-bearing compilation witness to the Gonggong / Nüwa cosmogony; Birrell 1993, *Chinese Mythology: An Introduction*, chapters on cosmogony, on the *Liezi*'s cosmogonic material; the specific "Daoist-philosophical framing" characterisation reflects the *Liezi*'s known Daoist context within the early-Chinese textual tradition rather than a directly-attributable Birrell phrasing and is flagged for verification at glossary-lock against the printed text.]
// EVIDENCE: source_id=lewis-2006-flood ; loc=chs. 2-3
...
The chapter's general long-arc framing-anchor is Neil Forsyth's *The Old Enemy: Satan and the Combat Myth* (Princeton University Press, 1987), whose Sumer-through-Judeo-Christian-apocalyptic survey supplies the combat-myth typology within which the present chapter situates the Gonggong narrative as a non-cognate parallel to (rather than a member of) Forsyth's Near-Eastern-and-Judeo-Christian arc; the typological framing — not Chinese-material coverage — is what Forsyth supplies for the chapter's forward-link to Part II C1 of the present book.footnote:[Forsyth 1987, *The Old Enemy: Satan and the Combat Myth*, treatment of the combat-myth long-arc from Sumer through Judeo-Christian apocalyptic as the typological framing within which the present chapter situates the Gonggong narrative as a non-cognate parallel; Forsyth 1987 does not treat Chinese material directly, and the present chapter's use is for the long-arc typological framing rather than for Gonggong-specific scholarly coverage; brief 21-gonggong.yaml sources.secondary entry on Forsyth 1987.]
...
Nüwa (女媧), the serpent-tailed creator-goddess who repairs the broken sky after the combat, is one of the principal cosmogonic figures of the early-imperial Chinese pantheon and is associated more broadly with the creation of humans (in some Han sources, by moulding humans from yellow earth) and with the mending and ordering of the cosmos; her role in the Gonggong narrative is the post-combat repair-cosmogony rather than the combat itself.footnote:[Birrell 1993, *Chinese Mythology: An Introduction*, chapters on cosmogony, on Nüwa's wider creation-and-mending role across the Han sources including the human-creation-from-yellow-earth tradition; Lewis 2006, *The Flood Myths of Early China*, chs. 2–3 on Nüwa specifically as serpent-tailed creator-goddess and post-combat repairer of the sky in the Gonggong cycle (Lewis 2006's flood-myths focus covers the post-combat repair role; the wider human-creation tradition is Birrell's general-survey territory); brief 21-gonggong.yaml entities_glossary entry on Nüwa as serpent-tailed creator-goddess; glossary 'Nüwa' first_mention_gloss on the same.]
// EVIDENCE: source_id=birrell-1993 ; loc=chapters on cosmogony
...
The five-coloured stones are presented in the Han sources as a technical-cosmological material rather than as a generic patch: their five colours have been connected by subsequent Han and post-Han Chinese cosmological writing — and by modern scholarly readings of that writing — with the Five Phases or Five Elements (wuxing 五行) framework (wood, fire, earth, metal, water) that organises Han cosmography, although the wuxing correspondence is a cosmological-system reading rather than a feature directly stated within the *Huainanzi*-and-parallel narrative-form sources themselves.footnote:[Birrell 1993, *Chinese Mythology: An Introduction*, chapters on cosmogony, on the technical-cosmological character of the five-coloured-stones material; the explicit wuxing / Five-Phases correspondence is a cosmological-system reading whose specific articulation in Birrell 1993's cosmogony chapters is flagged for verification at glossary-lock against the printed text; Lewis 2006, *The Flood Myths of Early China*, chs. 2–3, on the technical-cosmological character of the five-coloured-stones material.]
// EVIDENCE: source_id=birrell-1993 ; loc=chapters on cosmogony
...
The chapter's principal cross-cultural comparative companions, on the present book's own Part II C1 editorial framework, are the Mesopotamian Marduk-Tiamat combat (chapter 3 of the present volume), the Sumerian Ninurta-Asag combat (chapter 1), and the Mesoamerican Huitzilopochtli-at-Coatepec combat (chapter 24 of the present volume): each is a combat-cosmogony in the strong sense in which the present features of the cosmos emerge from the combat's aftermath, and Lewis 2006 chs. 2–3 supplies the strongly-cosmogonic characterisation of the Gonggong narrative on which the present chapter's contribution to the four-way comparative grouping rests.footnote:[Lewis 2006, *The Flood Myths of Early China*, chs. 2–3 on the strongly-cosmogonic characterisation of the Gonggong narrative; the four-way comparative grouping (Gonggong / Marduk / Ninurta / Huitzilopochtli) is the present book's own Part II C1 editorial framework — not a Lewis 2006 comparative claim — with Lambert 2013 anchoring the Mesopotamian comparanda and Matos Moctezuma 1988 anchoring the Mesoamerican comparandum; brief 21-gonggong.yaml comparative_hooks on the Part II C1 grouping.]
// EVIDENCE: source_id=lewis-2006-flood ; loc=chs. 2-3 (Gonggong-specific characterisation)

[INFERENCE: the four-way grouping of Gonggong / Marduk-Tiamat / Ninurta-Asag / Huitzilopochtli-at-Coatepec as "the four clearest cosmogonic-combat cases across non-cognate traditions" is the present book's Part II C1 editorial framework — articulated by the project rather than by any single source. | basis: Lewis 2006 chs. 2–3 on the Gonggong narrative's strongly-cosmogonic characterisation; Lambert 2013 on Marduk-Tiamat; van Dijk 1983 on Ninurta-Asag; Matos Moctezuma 1988 on Huitzilopochtli-at-Coatepec; brief 21-gonggong.yaml comparative_hooks on the C1 grouping; scope.md §"Book structure" Part II C1 on combat as cosmogony. | risk: Lewis 2006 (a Chinese-tradition specialist monograph) does not itself assert this comparative grouping; treating Lewis as the source for the four-way placement would be a false attribution. The grouping is the present book's editorial synthesis across non-cognate traditions, drawing the cosmogonic characterisations of the four members from their respective specialist anchors.]

The chapter's general long-arc framing-anchor is Forsyth 1987's combat-myth typology — drawn from the Sumer-through-Judeo-Christian-apocalyptic arc that Forsyth's *The Old Enemy* surveys — within which the present chapter situates the Gonggong narrative as a non-cognate cosmogonic-combat parallel; Forsyth supplies the typological framing of the cosmogonic-combat type as a recurring structural feature across non-cognate traditions, not direct scholarly coverage of the Chinese material itself.footnote:[Forsyth 1987, *The Old Enemy: Satan and the Combat Myth*, combat-myth long-arc typology (Sumer through Judeo-Christian apocalyptic) as the typological framing within which the present chapter situates the Gonggong narrative as a non-cognate parallel; Forsyth 1987 does not treat Chinese material directly; brief 21-gonggong.yaml sources.secondary entry on Forsyth 1987.]
// EVIDENCE: source_id=forsyth-1987 ; loc=combat-myth long-arc typology (Sumer through Judeo-Christian apocalyptic)
...
// Checks passed: footnote+evidence-pair (56/56), source_id-whitelist, glossary-discipline, markers-valid
// Fixes applied: FC-01 HIGH (Forsyth scope — both occurrences at lines 55-56 and 181-182 reframed: prose changed from "treatment of non-Near-Eastern combat-myth supplies a wider scholarly anchor" to "Sumer-through-Judeo-Christian-apocalyptic survey supplies the combat-myth typology within which the present chapter situates the Gonggong narrative as a non-cognate parallel"; both EVIDENCE loc tags updated from "loc=on non-Near-Eastern combat-myth" to "loc=combat-myth long-arc typology (Sumer through Judeo-Christian apocalyptic)"; footnotes expanded to make explicit that Forsyth 1987 does not treat Chinese material directly and that the chapter's use is for the long-arc typological framing rather than for Gonggong-specific scholarly coverage. The MODIFY rather than RETAG approach is consistent with Ch19's use of Forsyth as "secondary survey-anchor" / "loc=on IE combat-myth" for non-Near-Eastern material that nevertheless sits within Forsyth's typological frame); FC-02 HIGH (Lewis 2006 cannot anchor the four-way Gonggong / Marduk / Ninurta / Huitzilopochtli grouping — line 178 prose reframed to attribute the four-way grouping to "the present book's own Part II C1 editorial framework" and to specify that "Lewis 2006 chs. 2–3 supplies the strongly-cosmogonic characterisation of the Gonggong narrative on which the present chapter's contribution to the four-way comparative grouping rests"; footnote rewritten to distinguish Lewis (Gonggong-specific) from Lambert 2013 (Mesopotamian comparanda) and Matos Moctezuma 1988 (Mesoamerican comparandum); EVIDENCE tag updated to "loc=chs. 2-3 (Gonggong-specific characterisation)"; new [INFERENCE] marker added immediately after the claim to explicitly mark the four-way grouping as the present book's editorial synthesis with Lewis-as-source disclaimer in the risk field — the [INFERENCE] marker does not count toward the 56-claim invariant since markers are structural rather than body-claim elements); FC-03 MEDIUM (line 111 — wuxing/Five-Phases connection softened: "are read in subsequent Han and post-Han Chinese cosmological writing as corresponding to the Five Phases" → "have been connected by subsequent Han and post-Han Chinese cosmological writing — and by modern scholarly readings of that writing — with the Five Phases or Five Elements (wuxing 五行) framework... although the wuxing correspondence is a cosmological-system reading rather than a feature directly stated within the *Huainanzi*-and-parallel narrative-form sources themselves"; footnote updated to flag Birrell 1993 cosmogony-chapters wuxing-articulation for verification at glossary-lock); FC-04 MEDIUM (line 80 — Nüwa human-creation footnote citation order reordered: Lewis 2006 first → Birrell 1993 first; footnote text updated to specify "Birrell 1993... on Nüwa's wider creation-and-mending role across the Han sources including the human-creation-from-yellow-earth tradition" and "Lewis 2006... specifically as serpent-tailed creator-goddess and post-combat repairer of the sky in the Gonggong cycle (Lewis 2006's flood-myths focus covers the post-combat repair role; the wider human-creation tradition is Birrell's general-survey territory)"; EVIDENCE tag retagged from source_id=lewis-2006-flood (loc=chs. 2-3) to source_id=birrell-1993 (loc=chapters on cosmogony) to match the new lead-anchor); FC-05 LOW (line 37 — Liezi Daoist-philosophical-framing softened: "with characteristic Daoist-philosophical framing of the combat-and-repair sequence as a cosmological aetiology" → "presenting the combat-and-repair sequence as a cosmological aetiology within the compilation's broader cosmological-aetiological-and-Daoist register"; footnote updated to flag the specific Daoist-philosophical-framing characterisation for verification at glossary-lock).
// Sources.yaml additions: none (no new source_ids needed; Forsyth 1987 retained as the long-arc framing-anchor with corrected loc tag; the established practice from Ch19/Ch20 of using Forsyth at chapter-level for combat-myth typology framing is followed).
// Briefs / governing-document changes: none (briefs/21-gonggong.yaml's secondary source-loc "on non-Near-Eastern combat-myth" remains as written in the brief; the claims document's revised loc tag and prose are the authoritative correction without requiring an upstream brief edit, since the brief's loc descriptor is itself an instance of the same mischaracterisation that the claims-document fix corrects, and a brief edit would be a contained-fix duplicate of the claims-document fix; if a future stage requires the brief's loc to match the claims document's revised wording, the brief edit can be made then).
// Warnings: none. Banned umbrella terms ("chaos-figure", "chaos-monster", "chaos-serpent") not present in body prose, footnotes, or COMPARATIVE-HOOK comments. Glossary discipline holds (Gonggong, Zhuanxu, Zhurong, Nüwa, Mount Buzhou, Yu the Great, five-coloured stones, *Huainanzi*, *Lienü zhuan*, *Shanhaijing*, *Liezi*, *wuxing*, Liu An, Liu Xiang, Guo Pu in conventional scholarly forms throughout). Source-overview register: the source-overview section's register is technical-academic (consistent with the chapter's CORE-tier composite-editorial requirements); no register-softening applied since the audit's findings did not flag overview register and the user-feedback memory's "Source overviews too academic" note is for future books rather than retroactive softening of an already-fact-checked CORE chapter at post-human-normalize.
```

---

# Input file: briefs/21-gonggong.yaml
...
sources:
  primary:
    - id: lewis-2006-flood
      loc: "The Flood Myths of Early China, chs. 2–3 (Gonggong, Nüwa, and the broken-pillar cosmogony); and chapters on Yu the Great used for the sidebar"
      translator_edition: "Lewis 2006"
      identifier: "ISBN 9780791466636"
      url_or_file: ~
    - id: birrell-1993
      loc: "Chinese Mythology: An Introduction, chapters on cosmogony"
      translator_edition: "Birrell 1993"
      identifier: "ISBN 9780801849954"
      url_or_file: ~
  secondary:
    - { id: forsyth-1987, loc: "on non-Near-Eastern combat-myth" }
    - { id: scurlock-beal-2013, loc: "limited references to Chinese material" }

lacunae:
  - source: lewis-2006-flood
    location: "Huainanzi 天文訓; Lienü zhuan (2nd–1st c. BCE)"
    what_is_missing: "Narrative details vary significantly across the Han compilations; no primary Warring States source preserves a complete Gonggong narrative"
    in_tradition_fills_available: "partial — the Shanhaijing, Huainanzi, and later commentaries together give a partial composite"

variants:
  classification: co-equal
  prevalent_version:
    source: lewis-2006-flood
    why_prevalent: "Lewis 2006 is the standard English-language synthesis of the Gonggong cycle. The Huainanzi is the fullest single account but is itself a 2nd c. BCE compilation of earlier material."
  alternates:
    - source: birrell-1993
      difference: "Huainanzi version: Gonggong fights Zhuanxu (or in some versions Zhurong) and loses; in rage, he strikes Mount Buzhou, breaking the sky-pillar and tilting the cosmos. Nüwa repairs with five-colored stones and the legs of a giant turtle"
    - source: lewis-2006-flood
      difference: "Lienü zhuan and other Han sources: Gonggong's combat is followed by the flood, which Yu the Great tames by opening channels — a sequential cosmogonic drama rather than two separate stories"
    - source: birrell-1993
      difference: "Shanhaijing and commentaries: different opponents for Gonggong (Zhuanxu, Zhurong, and others); fragmented into multiple mini-traditions"

entities_glossary:
  - name: "Gonggong (共工)"
    role: deity
    first_mention_gloss_candidate: "water-god, often red-haired and serpent-bodied; the defeated combatant who strikes the sky-pillar"
  - name: "Zhuanxu (顓頊)"
    role: deity
    first_mention_gloss_candidate: "the sky-emperor who defeats Gonggong in the most widely attested version"
  - name: "Nüwa (女媧)"
    role: deity
    first_mention_gloss_candidate: "serpent-tailed creator-goddess; repairs the broken sky with five-coloured stones"
  - name: "Mount Buzhou (不周山)"
    role: place
    first_mention_gloss_candidate: "'mountain-that-is-not-whole'; the pillar of heaven, broken by Gonggong's head-blow"
  - name: "Yu the Great (大禹)"
    role: hero
    first_mention_gloss_candidate: "post-combat flood-controller; his hydraulic ordering is the sidebar contrast in this chapter"
  - name: "five-coloured stones (五色石)"
    role: artifact
    first_mention_gloss_candidate: "the stones Nüwa melts to patch the sky"

cultural_relevance:
  centrality: central
  centrality_evidence:
    - kind: attestation-volume
      detail: "The Gonggong narrative is preserved across multiple Han-era compilations (Huainanzi, Lienü zhuan, commentaries on the Shanhaijing, Liezi) — the single most widely attested early-imperial Chinese cosmogonic combat"
      source: "lewis-2006-flood; birrell-1993"
    - kind: scholarly-attention
      detail: "Lewis 2006 treats the Gonggong narrative as the standard Chinese cosmogonic-combat comparandum in the comparative flood / cosmogony literature"
      source: "lewis-2006-flood"
    - kind: ritual-context
      detail: "Less directly liturgical than Near Eastern cases, but the cosmogony is cited in Han ritual and political texts to explain the asymmetric tilt of the cosmos (why rivers flow east)"
      source: "lewis-2006-flood"
  function:
    - role: cosmological
      basis: "The combat-plus-repair explains the present asymmetry of the cosmos: heaven tilts northwest, earth tilts southeast, and rivers flow east to the sea"
      source: "lewis-2006-flood; birrell-1993"
    - role: royal-legitimation
      basis: "Sky-emperors (Zhuanxu, Zhurong) defeat Gonggong as legitimate rulers; the combat is part of the succession of pre-human emperors"
      source: "lewis-2006-flood"
  cross_cultural_parallels:
    - other_culture: "Mesopotamia (Marduk)"
      parallel: "Both are combat-cosmogonies in the strong sense: the present features of the cosmos (asymmetry, rivers, geography) emerge from the combat's aftermath. Part II C1 pairs them"
      source: "lewis-2006-flood; lambert-2013"
    - other_culture: "Mesoamerica (Huitzilopochtli)"
      parallel: "Both Gonggong and Huitzilopochtli-at-Coatepec are combat-cosmogonies with explicit geographical aetiology (Mount Buzhou; Templo Mayor = Coatepec)"
      source: "lewis-2006-flood; matos-moctezuma-templo-mayor"
    - other_culture: "Sumer (Ninurta)"
      parallel: "Gonggong's water-releasing-through-broken-earth parallels Ninurta's post-combat reordering of the Tigris — both are storm-or-water-gods shaping hydrography through combat"
      source: "vandijk-1983-lugale; lewis-2006-flood"

comparative_hooks:
  - other_culture: "Mesopotamia / Mesoamerica"
    parallel: "Part II C1 (combat as cosmogony) pairs Gonggong with Marduk, Ninurta/Asag, and Huitzilopochtli as the four clearest cosmogonic-combat cases across non-cognate traditions"
    source: "lewis-2006-flood; lambert-2013; matos-moctezuma-templo-mayor"
  - other_culture: "China (Yu)"
    parallel: "The Yu sidebar within this chapter contrasts the combat-ordering of Gonggong with the hydraulic-ordering of Yu: the same tradition producing two different templates for cosmic order"
    source: "lewis-2006-flood"
...
special_instructions: |
  The chapter has an embedded Yu-the-Great sidebar (per scope.md §"Book structure" cluster 9).
  The sidebar's job is to show that within the same Chinese tradition, two different templates
  for cosmic ordering coexist — combat (Gonggong) and channel-opening (Yu). Do not expand the
  sidebar into a chapter of its own; keep it as a 800–1200-word section within Chapter 21.
  Present the Huainanzi and Lienü zhuan variants side by side; neither is scholarly-privileged.
  Include the post-combat geography (tilted cosmos, rivers flowing east) as the cosmogonic
  outcome — this is the chapter's cosmogonic credential for Part II C1. Area-specialist
  citation policy applies: cite Lewis and Birrell by name in the first factual pass.
```
