...
# Book: chaoskampf
# Generated: 2026-05-03T09:46:58Z
...
# Input file: chapters/35-C2-combat-as-sovereignty.claims.approved.adoc
...
# Input file: chapters/35-C2-combat-as-sovereignty.adoc
...
What follows is organised in six body sections. Section I presents the seven cases — Baal-Yamm, Zeus-Typhon, Indra-Vṛtra, Thraētaona-Aži Dahāka, Teshub-Ullikummi, Ninurta-Anzû, and Yahweh-Leviathan-Rahab — in compressed comparative form focused on the sovereignty outcome of each combat; section II articulates Ballentine 2015's alternative-sovereign reading at length, with attention to the per-tradition philological evidence on which it rests; section III draws the operational distinction between the sovereignty-combat subtype and the cosmogonic-combat subtype treated in Ch34 (C1); section IV documents the Anzû-to-Marduk genealogy as the chapter's best-attested case of a sovereignty-combat being escalated within one tradition into a cosmogonic-combat; section V engages the transmission-vs-typology question by examining the four documented transmission-and-inheritance lines (Ugaritic-into-Hebrew, Hurro-Hittite-into-Greek, IE inheritance, within-Mesopotamian Anzû-to-Marduk) against the residual independent-typology component; and section VI examines the ritual-and-state context in which sovereignty combats are performed (akītu, Ṣapānu palace-founding, Olympian succession, soma sacrifice, Avestan yasht, Hebrew Bible poetic-cultic corpus, Neo-Assyrian royal ritual) and closes with the chapter's settled position on the inherited "chaos" terminology.

=== I. The pattern

The first body section presents the seven cases the chapter compares — Baal-Yamm, Zeus-Typhon, Indra-Vṛtra, Thraētaona-Aži Dahāka, Teshub-Ullikummi, Ninurta-Anzû, and Yahweh-Leviathan-Rahab — in compressed form focused on the sovereignty outcome of each combat (kingship gained, restored, or legitimated; rival sovereign defeated; throne, palace, or temple founded) rather than on the combat-narrative itself.
...
The second body section articulates Ballentine 2015's alternative-sovereign reading at length, with attention to the per-tradition philological evidence — Ugaritic, Hebrew, Akkadian, Iranian — on which the reading rests, and to the chapter's adoption of the reading as principal interpretive frame for this subtype.
...
The third body section draws the operational distinction between the sovereignty-combat subtype engaged in the present chapter and the cosmogonic-combat subtype engaged in Ch34 (C1), with attention to the boundary cases (Marduk-Tiamat as combined sovereignty-and-cosmogony case, Indra-Vṛtra as near-case) and to the structural and textual features that distinguish the two subtypes.
...
The fourth body section documents the Anzû-to-*Enūma Eliš* genealogy as the chapter's best-attested case of a sovereignty-combat being deliberately reworked within one tradition into a cosmogonic-combat, with attention to the structural-and-verbal reproduction of the Anzû template in *Enūma Eliš* and to the cosmogonic-element addition that marks the within-Mesopotamian escalation.
...
The fifth body section engages the transmission-vs-typology question by examining the four documented transmission-and-inheritance lines that connect the chapter's seven cases (Ugaritic-into-Hebrew, Hurro-Hittite-into-Greek, Indo-European inheritance, within-Mesopotamian Anzû-to-Marduk) and weighs them against the residual independent-typology component.
...
The sixth body section examines the ritual-and-state context in which the chapter's seven sovereignty combats are performed — akītu New Year recitation, Ṣapānu palace-founding, Olympian *timai*-distribution, soma sacrifice, Avestan yasht-prayer, Hebrew Bible poetic-cultic corpus, Neo-Assyrian royal ritual — and closes with the chapter's settled position on the inherited "chaos" terminology.
