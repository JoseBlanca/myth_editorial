...
# Input file: chapters/04-mesopotamian-minor.claims.approved.adoc
...
The Akkadian text known to scholars as the "Slaying of Labbu" (a title used in Lambert 2013) survives on a single fragmentary cuneiform tablet; in Foster's *Before the Muses* it appears under the title "The Lion-Serpent" within the "Monster Serpents" group, and the working English translation runs to about two pages.footnote:[Foster 2005, pp. 581–582, "The Lion-Serpent" (full translation); Lambert 2013, pp. 361–365, on the same fragment under the title "The Slaying of Labbu".]
...
The chapter relies on Foster 2005 for the working English translation and on Wakeman 1973 for the interpretive scholarship; supplementary placement of the fragment within the Mesopotamian combat corpus draws on Lambert 2013 and Forsyth 1987.footnote:[Foster 2005, pp. 581–582; Wakeman 1973, pp. 21–26; Lambert 2013, pp. 361–365 on the Labbu fragment within the Akkadian combat corpus; Forsyth 1987, ch. 2 on Mesopotamian combat.]
// EVIDENCE: source_id=foster-2005 ; loc=pp. 581-582
...
The text gives Labbu a measurement that places the dragon on a scale of cosmic monstrosity comparable to Tiamat in *Enūma Eliš*, though without the cosmogonic framing; the surviving witnesses give the length variously as fifty leagues (in the manuscripts that read the dragon's species as *bašmu*) or sixty leagues (in those that read it as *mušḫuššu*).footnote:[Foster 2005, p. 581, on Labbu's measurement; Wakeman 1973, pp. 21–22, on the dimensions as a marker of the dragon's cosmic scale and on the witness-dependent length.]
// EVIDENCE: source_id=foster-2005 ; loc=p. 581
...
The text gives the dragon's bleeding a temporal duration — three years, three months, one day, and one night — a motif of monstrous excess attested in the surviving lines.footnote:[Foster 2005, p. 582, on the duration of the blood-flow following the slaying.]
// EVIDENCE: source_id=foster-2005 ; loc=p. 582
...
The case for Marduk is comparative: the cloud-and-wind instrumentation, the divine-assembly framing, and the slaying of a serpent-dragon-of-the-deep all align with the Marduk-Tiamat narrative attested elsewhere.footnote:[Wakeman 1973, pp. 23–25, on the structural parallels with the Marduk-Tiamat tradition.]
// EVIDENCE: source_id=wakeman-1973 ; loc=pp. 23-25

The most strongly supported reading in the recent scholarship identifies the slaying god as Tishpak, the patron deity of the city of Eshnunna in the Diyala region — particularly in the Neo-Assyrian witness, where the surrounding context fits Tishpak's profile.footnote:[Wakeman 1973, pp. 23–25, surveying the Tishpak proposal; Lambert 2013, pp. 361–365, on the Tishpak-and-Eshnunna context for Mesopotamian combat material.]
// EVIDENCE: source_id=wakeman-1973 ; loc=pp. 23-25
...
The three identifications are not equally weighted in the scholarship: Tishpak is the leading candidate in the Neo-Assyrian recension on contextual grounds, Nergal has been proposed in earlier reconstructions on the strength of his violent profile, and Marduk has been suggested as a structural parallel rather than a textually-grounded reading.footnote:[Wakeman 1973, pp. 23–25, surveying the three identifications; Lambert 2013, pp. 361–365.]
// EVIDENCE: source_id=wakeman-1973 ; loc=pp. 23-25
...
# Input file: chapters/04-mesopotamian-minor.adoc
