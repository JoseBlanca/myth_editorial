...
# Book: chaoskampf
# Generated: 2026-04-28T05:14:09Z
...
# Input file: chapters/15-vedic-reflexes.claims.approved.adoc

```
[[ch-15-vedic-reflexes-claims]]
== Vedic and Post-Vedic Reflexes (Trita Āptya, Krishna/Kāliya) — Claims

// One fact per paragraph; chapter-draft will transform this into narrative.
// Family-chapter (related-tier) treatment of two clearly-distinct Indian
// dragon-combat sub-cases that bracket the Indra-Vṛtra flagship of the
// preceding chapter: the older Indo-Iranian Trita Āptya stratum (Rigveda
// 10.99.6; 1.105; 2.11.19–20), and the bhakti-era Krishna-Kāliya
// reworking (Harivaṃśa, Viṣṇu Purāṇa, Bhāgavata Purāṇa 10.15–17). The
// two sub-cases are treated in their own === sub-sections and must not
// be merged: Trita Āptya is pre-Indra Indo-Iranian; Krishna-Kāliya is
// post-Vedic Vaishnava devotional, with the combat's killing-pole
// transformed into non-lethal subjugation and the warrior-pole replaced
// by the child-hero's līlā. Per brief, target chapter length 4,500 words.

=== Source overview

The chapter treats two clearly-distinct Indian dragon-combat sub-cases that bracket the Indra-Vṛtra flagship of the preceding chapter: the older Indo-Iranian Trita Āptya stratum, attested in a small cluster of Rigvedic hymns, and the bhakti-era Krishna-Kāliya reworking, attested in the *Harivaṃśa*, the *Viṣṇu Purāṇa*, and the *Bhāgavata Purāṇa*.footnote:[Per brief 15-vedic-reflexes.yaml; Jamison and Brereton 2014 on the Trita Āptya material in the Rigvedic corpus; Forsyth 1987, ch. 2, on the long arc of Indian dragon-combat material from the Rigveda to the bhakti-period reworkings.]
// EVIDENCE: source_id=jamison-brereton-2014 ; loc=Trita Āptya material

The chapter's primary text for the Trita Āptya material is the Rigveda (Sanskrit Ṛgveda), the same Vedic Sanskrit corpus that supplies the Indra-Vṛtra material of the preceding chapter, cited in the present chapter at hymn-and-verse granularity (RV book.hymn.verse) keyed to Stephanie Jamison and Joel Brereton's three-volume *The Rigveda: The Earliest Religious Poetry of India*, published by Oxford University Press in 2014.footnote:[Jamison and Brereton 2014, *The Rigveda: The Earliest Religious Poetry of India*, three-volume Oxford translation, ISBN 9780199370184, used as the working English text for all Rigvedic material.]
...
Watkins's monograph is printed-only and is cited at section and chapter level in the present chapter, with the Trita-cluster discussion drawn from chapters 44 to 45 of Part V and the wider HERO SLAY SERPENT framework drawn from the surrounding chapters of the same Part.footnote:[Watkins 1995, Part V (printed only; cited at chapter and section level per the established discipline for this book).]
...
The Trita-Thraētaona cognancy is documented at the level of the two figures' names: both names are formed from the Indo-Iranian root for "third" plus a patronymic-or-toponymic suffix, and the regular phonological correspondences between Vedic Sanskrit and Avestan are visible across the pair (Vedic *tr-* / Avestan *thr-*; Vedic *-i-* / Avestan *-aē-*; Vedic *-a* / Avestan *-aona*).footnote:[Benveniste and Renou 1934, on the phonological correspondences across the Trita / Thraētaona pair; Watkins 1995, Part V, on the regular sound-laws of the cognancy.]
// EVIDENCE: source_id=benveniste-renou-1934 ; loc=Trita-Thraētaona discussion

The Trita-Thraētaona cognancy is documented at the level of the two figures' adversaries: both slay a three-headed serpent-or-monstrous adversary, the Vedic adversary unnamed in the surviving hymn-allusions and the Avestan adversary named as Aži Dahāka (the "dragon-Dahāka"), and the structural identity of the two killings reinforces the philological cognancy of the names.footnote:[Benveniste and Renou 1934, on the structural identity of the Trita and Thraētaona killings; Watkins 1995, Part V (chs. 44–45), on the three-headed-adversary structural cognancy.]
// EVIDENCE: source_id=benveniste-renou-1934 ; loc=Trita-Thraētaona discussion
...
The Trita Āptya material is also the chapter's principal back-link to chapter 14 of the present volume (the Indra-Vṛtra chapter), in which the Trita-pre-Indra-stratum reading is briefly anticipated, and the present chapter develops the reading at the level of the specific Trita-cluster hymns that the Indra-Vṛtra chapter only references in passing.footnote:[Per brief 15-vedic-reflexes.yaml on the back-link to chapter 14; brief 14-indra-vrtra.yaml on the anticipation of the Trita-pre-Indra-stratum reading.]
// EVIDENCE: source_id=jamison-brereton-2014 ; loc=Trita Āptya material

=== Krishna and Kāliya — bhakti-era reworking

The Krishna-Kāliya episode is a post-Vedic Vaishnava devotional reworking of the Indian dragon-combat tradition, conventionally dated by its earliest fully-narrative witness (the *Harivaṃśa*) to roughly the 4th century CE and consolidated in its most famous and iconographically pervasive form in the *Bhāgavata Purāṇa* of the 9th to 10th century CE; the episode is therefore separated from the Rigvedic combat-corpus by more than a thousand years and by a major shift in the religious culture of the subcontinent, and it is treated in this chapter as a clearly-bounded post-Vedic transformation rather than as an alternative phrasing of the Rigvedic Indra-Vṛtra combat.footnote:[Forsyth 1987, ch. 2, on the post-Vedic Vaishnava devotional reworking of the Indian combat-tradition; brief 15-vedic-reflexes.yaml special_instructions on the no-merge rule with the Rigvedic combat.]
// EVIDENCE: source_id=forsyth-1987 ; loc=ch. 2
...
The Krishna-Kāliya episode's developed iconography of the dance-on-the-serpent's-heads — the child-hero standing on the multiple-headed serpent, often with one foot raised in the dance-pose and one or more hands holding a *vaṃśī* (flute) or assuming a gesture of authority — is one of the long-arc Indic visual tradition's most stable iconographic types, and its visual centrality is the principal cultural-relevance datum for the chapter's devotional-and-iconographic discussion of the episode.footnote:[Tagare 1976–78, *Bhāgavata Purāṇa* book 10 chs. 15–17, as the primary textual source for the dance-on-the-heads iconographic moment; Forsyth 1987, ch. 2, on the long-arc centrality of the *Kāliyamardana* in the Indic visual tradition.]
// EVIDENCE: source_id=tagare-bhagavata ; loc=BP 10.15-17
...
// Warnings: ch15: 4 LOW unverified findings (findings 3–7) resolved by Tagare addition (specialist Purāṇic source now anchors BP 10.15–17 narrative-detail claims)
```

---

# Input file: chapters/15-vedic-reflexes.adoc
