...
# Book: chaoskampf
# Generated: 2026-05-01T13:13:36Z
...
# Input file: chapters/29-mwindo-kirimu.claims.approved.adoc
...
// Checks passed: footnote+evidence-pair (48/48), source_id-whitelist, glossary-discipline, markers-valid
// Fixes applied: FC-01 LOW (geographic-precision, "eastern slopes of the Mitumba mountain range and the western fringes of the Kivu rift" at line 68 — MODIFY per task-instructions guidance: the auditor flagged the Mitumba-range and Kivu-rift labels as more specific than what the Biebuyck & Mateene 1969 translators' introduction supports, where the standard scholarly framing is broadly "Kivu region / upper Oso valley." Body prose at line 68 revised from "the upper Oso river valley and adjacent forested terrain on the eastern slopes of the Mitumba mountain range and the western fringes of the Kivu rift" to "the upper Oso river valley and adjacent forested terrain in the Kivu region of the eastern Congo," with the matching footnote tightened identically — the standard scholarly formulation. No EVIDENCE-token disposition change since the source_id biebuyck-mateene-mwindo was already correctly the anchor; the geographic claim is brought into alignment with what the anchor actually supports.); FC-02 NOTE (named-but-flagged specialists missing from sources.yaml — Biebuyck 1978 *Hero and Chief*, Hale 1998 *Griots and Griottes*, Pius Ngandu Nkashama, Mugyabuso M. Mulokozi, Charles S. Bird — FLAGGED-ONLY per Ch23 FC-02 / Ch26 FC-02 / Ch28 FC-02 named-but-flagged precedent: the named-but-flagged pattern is the established pipeline solution for this situation, and the chapter's APPROPRIATION-FLAG marker at line 172 and the LACUNA / VARIANT markers explicitly register the sources.yaml absence and defer to inventory-audit. No EVIDENCE token in the chapter routes through any of the five named-but-flagged secondaries (all EVIDENCE tokens route through biebuyck-mateene-mwindo, belcher-epic, or forsyth-1987). Pipeline-management addition of Biebuyck 1978, Hale 1998, and the three further specialists to sources.yaml is DEFERRED to inventory-audit, where the Bantu-and-African-oral-epic sub-registry can be expanded systematically alongside the Ch28 / Ch30 / Ch32 named-but-flagged pending entries. Note documented for chapter-draft: Bird's, Ngandu Nkashama's, and Mulokozi's specific publication titles and years remain unidentified; identification before chapter-draft is required to enable proper bibliographic handling. Bird's likely candidate is "Heroic Songs of the Mande Hunters" (1974) per the Ch28 FC-02 auditor's trained-knowledge note.); FC-03 NOTE (*karisi* gloss expansion at lines 56, 74, 142 — FLAGGED-ONLY for chapter-draft per task-instructions guidance: the first-mention parenthetical gloss at line 74 ("the praise-and-narrative singer-tradition's title") is adequate for a claims-stage document but brief; chapter-draft can expand the gloss per scope.md §"Book register" (plain-English register; every ancient-language term glossed at first occurrence) to a fuller glossary-style gloss identifying *karisi* as the Nyanga designation for the trained specialist reciter of the epic tradition. No claims-stage action; no revision to the .claims.approved.adoc file at this stage.).
// Sources.yaml additions: 0 new entries for Ch29 (Biebuyck 1978, Hale 1998, Ngandu Nkashama, Mulokozi, Bird all deferred to inventory-audit per FC-02 named-but-flagged disposition). Source count unchanged.
// Briefs / governing-document changes: 0 brief edits for Ch29 (no FC-finding required brief-level acknowledgement at this stage — FC-01 is a body-prose-and-footnote tightening on geographic specificity which is not encoded at the brief level; FC-02 named-but-flagged sources are deferred to inventory-audit; FC-03 is a forward chapter-draft glossing action).
// Warnings: none. Banned umbrella terms ("chaos-figure", "chaos-monster", "chaos-serpent") not present in body prose, footnotes, markers, or COMPARATIVE-HOOK comments. Glossary discipline holds (Mwindo, Kirimu, Nkuba, Shé-Kárisi Rureke, Bese, Bantu, Nyanga / Banyanga, Iyangura, Muisa, Shemwindo, Tubondo, *conga*-scepter, *karisi*, Biebuyck, Mateene, Belcher in conventional scholarly forms throughout). Forsyth disclaimer wording at line 51 verified as correct per the Ch28 exception-case-load-bearing precedent — the single Forsyth EVIDENCE token correctly characterises Forsyth as the long-arc combat-myth typology anchor against which the Mwindo / Kirimu narrative registers as the present book's clearest contrastive-case-tier resistance, with the explicit "not for Nyanga / Bantu-area content scholarly coverage" disclaimer and the load-bearing exception-case justification ("the contrastive reading depends on having a typology to refuse"). APPROPRIATION-FLAG marker at line 172 verified as complete per the four-component-plus-spectrum-positioning checklist (named area specialists Biebuyck/Mateene/Belcher/Hale/Ngandu Nkashama/Mulokozi/Bird; substance of typological-assimilation objection via celestial-authority-punishing-the-killer narrative form; CONTRASTIVE-tier implication with "the resistance is the data" framing; Ch41-as-PRIMARY / Ch40-as-secondary forwarding clause; spectrum positioning between Ch28 Bida covenant-and-consequence and Ch32 Nanabozho necessary-counterpart-dialectic). Source-overview register: technical-academic per the chapter's contrastive-case-tier (full) requirements; no register-softening applied since the audit's findings did not flag overview register.
```

---

# Input file: briefs/29-mwindo-kirimu.yaml
...
chapter_type: "contrastive (full)"

sources:
  primary:
    - id: biebuyck-mateene-mwindo
      loc: "The Mwindo Epic, episode of Kirimu"
      identifier: "ISBN 9780520003767"
    - id: belcher-epic
      loc: "Epic Traditions of Africa, ch. on Mwindo"
      identifier: "ISBN 9780253212818"
  secondary: []

variants:
  classification: single-prevalent
  summary: |
    The Biebuyck & Mateene 1969 text (Shé-Kárisi Rureke's performance) is the standard
    primary text. Biebuyck later published additional Nyanga epics with related material.
    The chapter uses Biebuyck & Mateene 1969 as the anchor.

summary: |
  In the Nyanga Mwindo epic, the hero kills the monstrous dragon Kirimu — and is then
  punished by the sky-god Nkuba for the killing. The moral valence is inverted from
  chaoskampf: the dragon-slaying is hubris, not order-making. The hero must undergo
  humiliation and re-integration.

cultural_relevance:
  centrality: |
    Central within Nyanga oral-epic tradition (one of the flagship African oral epics in
    20th-century scholarship); significant as type-case in African epic studies.
  function: |
    - Didactic (the hero's maturation through humiliation)
    - Social-moral (reciprocal balance between the human and spirit worlds)
    - Religious-political (the sky-god's authority over the hero)
  cross_cultural_parallels: |
    - Bida (Chapter 28) and Mwindo together make the African material the book's strongest
      "the pattern doesn't go where comparativists expect" cluster.
    - Mwindo's punishment-for-killing structurally echoes Krishna subduing-not-killing
      Kāliya (Chapter 15) — though the Krishna case is a moral transformation within the
      same tradition (Indra-as-precursor), whereas Mwindo is a different tradition entirely.

target_length_words: 5000

special_instructions: |
  CONTRASTIVE case per scope.md §"In-scope catalog" — treat as a full-length chapter that
  shows what a very thorough combat-myth looks like when its moral frame refuses chaoskampf.
  The chapter's role is load-bearing: it is the clearest case in the book of a tradition
  whose own framing explicitly rejects the chaos-order mapping. Area-specialist citation
  policy applies: cite Biebuyck and Mateene by name throughout; acknowledge the oral-
  performance context (Shé-Kárisi Rureke was the narrator in 1956). The chapter feeds
  Part II C7 (inversion) and especially C8 (refusal and appropriation). The chapter must
  not be apologetic about the Mwindo material's resistance to the chaoskampf frame —
