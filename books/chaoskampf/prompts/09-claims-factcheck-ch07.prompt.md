...
# Input file: chapters/07-baal-yamm-lotan.claims.adoc
...
# Input file: briefs/07-baal-yamm-lotan.yaml

```
chapter_number: 7
slug: "baal-yamm-lotan"
title: "Baal vs. Yamm and the Defeat of Lôtan (the Ugaritic Baal Cycle)"
chapter_anchor: "ch-07-baal-yamm-lotan"

sources:
  primary:
    - id: smith-1994-baal-i
      loc: "KTU 1.1–1.2 (Baal vs. Yamm): critical edition, transliteration, translation, commentary"
      translator_edition: "Smith 1994 (Vetus Testamentum Supplements 55)"
      identifier: "ISBN 9789004099951"
      url_or_file: ~
    - id: smith-pitard-2009-baal-ii
      loc: "KTU 1.3–1.4 (palace-building cycle); Lôtan passage at KTU 1.5 i 1–3 (critical edition and commentary)"
      translator_edition: "Smith & Pitard 2009 (VTSup 114)"
      identifier: "ISBN 9789004153486"
      url_or_file: ~
  secondary:
    - { id: day-1985, loc: "chs. 1–3 on the Baal Cycle and its Hebrew Bible reception" }
    - { id: ballentine-2015, loc: "ch. 2 on Baal-Yamm as rival-sovereignty combat, not chaos-combat" }
    - { id: forsyth-1987, loc: "ch. 3 on the Ugaritic material" }
    - { id: gunkel-1895, loc: "Teil I, on the Canaanite background to Hebrew Bible material" }
    - { id: wakeman-1973, loc: "on Baal-Yamm and Leviathan linkage" }

lacunae:
  - source: smith-1994-baal-i
    location: "KTU 1.1 throughout"
    what_is_missing: "This opening tablet is badly damaged; the sequence of events prior to Baal's investiture as divine warrior is partially reconstructed"
    in_tradition_fills_available: "yes, from KTU 1.2 internal cross-references and from thematic parallels in KTU 1.3–1.4"
  - source: smith-pitard-2009-baal-ii
    location: "KTU 1.5 i 1–3 (Lôtan passage)"
    what_is_missing: "The Lôtan reference is embedded as a boast by Mot; the narrative of the Lôtan combat itself is not preserved"
    in_tradition_fills_available: "no — the chapter must treat Lôtan as an allusion to a combat Baal has evidently already won, without filling in a 'Baal-Lôtan combat narrative' from parallels"

variants:
  classification: composite-editorial
  prevalent_version:
    source: smith-1994-baal-i
    why_prevalent: "Smith (1994) and Smith & Pitard (2009) are the definitive critical edition of the Baal Cycle; the chapter follows the KTU (Dietrich/Loretz/Sanmartín) tablet-numbering that both volumes use."
  alternates:
    - source: smith-1994-baal-i
      difference: "KTU 1.1 and 1.2 are heavily broken — several passages have two possible readings; Smith prefers the conservative, flagging variants in the commentary."

entities_glossary:
  - name: "Baʿlu / Haddu (bʿl, hd)"
    role: deity
    first_mention_gloss_candidate: "Ugaritic storm-god, son of Dagan, rendered Baal in Hebrew Bible tradition; combat-champion of the Cycle"
  - name: "Yamm (ym)"
    role: deity
    first_mention_gloss_candidate: "god of the sea; Baal's primary adversary; name literally 'Sea'"
  - name: "Lôtan (ltn)"
    role: deity
    first_mention_gloss_candidate: "seven-headed serpent; cognate with Hebrew Leviathan"
  - name: "Mot (mt)"
    role: deity
    first_mention_gloss_candidate: "god of death; Baal's adversary in the Cycle's second half"
  - name: "Kothar-wa-Khasis (kṯr w ḫss)"
    role: deity
    first_mention_gloss_candidate: "craftsman-god; forges Baal's mace-weapons Ayyamur and Yagrush"
  - name: "El (ʾil)"
    role: deity
    first_mention_gloss_candidate: "chief god, father of the divine assembly; the assembly's decision-maker"
  - name: "ʿAnat (ʿnt)"
    role: deity
    first_mention_gloss_candidate: "warrior-goddess; Baal's sister and fierce ally"
  - name: "Ayyamur / Yagrush"
    role: artifact
    first_mention_gloss_candidate: "Baal's two named maces, forged by Kothar, used in the combat with Yamm"
  - name: "Ṣapānu (ṣpn)"
    role: place
    first_mention_gloss_candidate: "mountain of Baal (Mount Zaphon / Jebel al-Aqra); his palace-seat after victory"

cultural_relevance:
  centrality: central
  centrality_evidence:
    - kind: attestation-volume
      detail: "The Baal Cycle survives on six Ugaritic tablets from the Late Bronze Age, the single most extensive Canaanite mythological text corpus"
      source: "smith-1994-baal-i introduction"
    - kind: scholarly-attention
      detail: "Since the decipherment of Ugaritic in the 1930s, the Baal Cycle has been the primary pre-Hebrew Bible West-Semitic combat-myth source; central to every Hebrew Bible combat-myth treatment"
      source: "day-1985; gunkel-1895 as reception"
    - kind: iconography
      detail: "The iconography of the storm-god standing on mountains, brandishing a mace, is pervasive in Late Bronze Age Levantine material culture"
      source: "smith-1994-baal-i introduction"
  function:
    - role: royal-legitimation
      basis: "Baal's elevation to divine kingship structures the cycle; Smith and Pitard argue the cycle is primarily about kingship, not cosmogony"
      source: "smith-1994-baal-i; smith-pitard-2009-baal-ii"
    - role: ritual-aetiological
      basis: "Baal's cycle of death and revival by Anat may have been tied to the agricultural calendar, though the ritual context is less directly attested than for Illuyanka"
      source: "smith-pitard-2009-baal-ii"
    - role: theogonic
      basis: "The succession-and-rivalry material (El's sons) has a theogonic dimension parallel to Kumarbi and Hesiod"
      source: "smith-1994-baal-i introduction"
  cross_cultural_parallels:
    - other_culture: "Hebrew Bible"
      parallel: "Day 1985's central argument: the imagery of Yahweh's combat with Leviathan, Rahab, and the sea in Psalms, Isaiah, and Job is directly continuous with Ugaritic Baal-Yamm and Baal-Lôtan material, with Lôtan and Leviathan (ltn, lwytn) as linguistically cognate"
      source: "day-1985"
    - other_culture: "Mesopotamia"
      parallel: "The storm-god-versus-sea pattern parallels Marduk-Tiamat structurally, though Baal's combat is sovereignty-focused rather than cosmogonic"
      source: "forsyth-1987"
    - other_culture: "Greek"
      parallel: "West and Burkert argue the Kumarbi-via-Phoenician route brought Baal-Yamm material into the Greek Zeus-Typhon story, via Levantine trading networks"
      source: "west-1997; burkert-1992"

comparative_hooks:
  - other_culture: "Hebrew Bible"
    parallel: "The chapter must set up the next (yahweh-leviathan-rahab) directly: Lôtan's seven heads match Leviathan's in Psalm 74; Isaiah 27's language of 'twisting serpent' preserves Ugaritic epithets verbatim"
    source: "day-1985"
  - other_culture: "Hebrew Bible (Ballentine)"
    parallel: "Ballentine 2015's alternative-sovereign reading — that Yamm and Leviathan are rival sovereigns rather than 'chaos' — rests on Smith and Pitard's reading of the Ugaritic source: this is the key pivot for the book's Part II C2"
    source: "ballentine-2015; smith-1994-baal-i"
  - other_culture: "Mesopotamia"
    parallel: "Baal's paired named weapons (Ayyamur / Yagrush) parallel Ninurta's Šarur and echo back to Lugal-e's animate-weapon motif — a probable areal rather than purely IE or Semitic feature"
    source: "smith-1994-baal-i"
...
special_instructions: |
  Structure: (1) KTU 1.1–1.2 Baal-Yamm combat with Kothar's weapons; (2) KTU 1.3–1.4 palace-building
  as the post-combat institution of Baal's kingship; (3) the Lôtan passage at KTU 1.5 i 1–3 as a
  retrospective allusion — do not narrativise a Baal-Lôtan combat, because there isn't one in the
  extant text; (4) a short note on the Mot cycle (KTU 1.5–1.6) as context but NOT as another
  chaoskampf. The chapter must engage Ballentine 2015 substantively: Yamm is literally "Sea" and
  his status as rival-king is on-text (El initially hands kingship to him). This is the book's
  clearest test-case for the Gunkel-Ballentine terminological debate. Flag the forthcoming
  yahweh-leviathan-rahab chapter (08) as the next step in the transmission.
```
