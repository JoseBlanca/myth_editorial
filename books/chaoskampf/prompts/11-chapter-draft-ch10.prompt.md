...
# Input file: chapters/10-christian-reception.claims.approved.adoc

```
[[ch-10-christian-reception-claims]]
== St. George, St. Michael, and the Christian Reception — Claims

// One fact per paragraph; chapter-draft will transform this into narrative.
// Family-chapter (related-tier) treatment: each of the three reception nodes
// (Michael / George / Christ-harrowing) gets its own === sub-section.
// Window: late antiquity to high Middle Ages. Post-medieval material is
// deferred to the Ch42 reception coda.

=== Source overview

The chapter traces the late-antique-to-high-medieval Christian refraction of the dragon-combat pattern as it passes from Revelation 12 into hagiographic narrative and devotional iconography.footnote:[Ogden 2013, *Drakōn: Dragon Myth and Serpent Cult in the Greek and Roman Worlds*, chs. 11–12, on the Christian dragon-combat material; Forsyth 1987, *The Old Enemy*, on the Christian afterlife of the combat myth.]
// EVIDENCE: source_id=ogden-2013 ; loc=chs. 11-12

The scholarly anchor for the chapter is Daniel Ogden's *Drakōn: Dragon Myth and Serpent Cult in the Greek and Roman Worlds*, published by Oxford University Press in 2013, with chapters 11 and 12 surveying the late-antique and medieval Christian dragon-combat corpus.footnote:[Ogden 2013, chs. 11–12, full chapter coverage.]
// EVIDENCE: source_id=ogden-2013 ; loc=chs. 11-12

Ogden's two chapters treat the Greco-Roman *drakōn* tradition's continuity into Christian hagiography, classifying the soldier-saint dragon-fight type and the archangel dragon-fight type as variants of an inherited iconographic complex.footnote:[Ogden 2013, chs. 11–12, on the continuity from Greco-Roman *drakōn* to Christian hagiography.]
// EVIDENCE: source_id=ogden-2013 ; loc=chs. 11-12
...
The iconographic codification of Michael as a militarised warrior-angel — armoured, helmeted, holding a spear or sword, and depicted in the act of trampling or piercing a dragon underfoot — develops through the Byzantine and Latin medieval centuries as a visual realisation of the Rev 12 narrative.footnote:[Ogden 2013, ch. 11, on the iconographic codification of the warrior-Michael.]
// EVIDENCE: source_id=ogden-2013 ; loc=ch. 11
...
The dragon-fight episode — in which the saint, riding into the territory of a city terrorised by a dragon that demands tributary sacrifice and is about to devour the king's daughter, kills or wounds the dragon, rescues the princess, and converts the city — is documented as a later accretion onto the original martyr-narrative, attached to the saint's *vita* by the eleventh and twelfth centuries.footnote:[Ogden 2013, ch. 11, on the dragon-fight episode as an 11th–12th-century accretion onto the original *passio*.]
// EVIDENCE: source_id=ogden-2013 ; loc=ch. 11
...
# Input file: briefs/10-christian-reception.yaml
...
sources:
  primary:
    - id: ogden-2013
      loc: "Drakōn, chs. 11–12 (late antique and medieval Christian dragon-combat material)"
      identifier: "ISBN 9780199557325"
  secondary:
    - { id: yarbro-collins-1976, loc: "on Rev 12 as source material for later iconography" }
    - { id: forsyth-1987, loc: "later chapters on the Christian afterlife of the combat myth" }

family_members:
  - name: "St. Michael the Archangel (drawing on Rev 12)"
    summary: "The cult of the warrior-archangel — high medieval through early modern — develops directly from Rev 12's combat narrative. Michael's iconography (armour, spear, trampled dragon) preserves the combat-pattern through Christian devotional culture."
  - name: "St. George and the dragon"
    summary: "Late-antique passio narratives of the soldier-saint martyred under Diocletian acquire, by the 11th–12th centuries, the princess-and-dragon rescue episode (which has a documented Greco-Roman substrate in the Perseus-Andromeda type). The combined figure becomes one of medieval Europe's most widespread iconographic types."
  - name: "Christ's harrowing of hell and defeat of the dragon"
    summary: "Apocryphal material (Gospel of Nicodemus) and patristic homily present Christ's descent into hell as a combat with the devil-as-dragon; a conceptual cousin of the George/Michael pattern."

shared_variant_handling: |
  Multiple recensions of the Passio S. Georgii; standard editions (Legenda Aurea, Acta
  Sanctorum) to be pinned at glossary-lock. The princess-episode is a later accretion and
  should be treated as such in the chapter's philological framing. Ogden 2013 is the
  scholarly anchor for both Michael and George.

cultural_relevance:
  centrality: significant
  function: "ritual-devotional (cult of the saints); didactic (exemplary virtues); iconographic (art, heraldry)"
  cross_cultural_parallels: |
    - The George narrative's princess-rescue has Greek antecedents (Perseus-Andromeda, Chapter 12 family).
    - Michael's iconography preserves Rev 12 directly (Chapter 9).
    - The hagiographic-combat pattern spreads beyond Christian Europe via Byzantine iconographic transmission.

target_length_words: 4500

special_instructions: |
  The chapter traces how the Rev 12 combat-imagery is refracted into medieval Christian
  hagiography and iconography. The post-medieval reception (Renaissance art, heraldry,
  modern national iconography) is deferred to the reception coda (Chapter 42). This chapter
  treats the LATE ANTIQUE TO HIGH MEDIEVAL material — where the primary-text situation is
  hagiographic texts and early visual corpora. Identifier pinning for specific Passio
  editions is deferred to glossary-lock per inventory notes.
```
