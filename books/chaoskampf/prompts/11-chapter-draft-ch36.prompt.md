...
# Book: chaoskampf
# Generated: 2026-05-03T09:30:45Z
...
# Input file: chapters/36-C3-cyclical-maintenance.claims.approved.adoc
...
// Comparative chapter (Part II) per brief 36-C3-cyclical-maintenance.yaml.
// The chapter argues that combat-as-recurring-ritual is a distinct subtype of
// the chaoskampf typology — neither one-time cosmogony (C1) nor episodic
// sovereignty succession (C2) nor cosmic-time-closing eschatology (C4) — and
// that Ra-Apep (daily) and Tarḫunna-Illuyanka (annual) are its two strong
// attestations, with the Apollo-Python Septerion at Delphi as a minor
// cult-foundation reflex. Per the brief special_instructions the chapter is
// short by design, target 5,500 body-prose words; do not pad. Per the brief,
// Assmann's maʿat / isfet framework supplies the conceptual through-line.
// Section structure follows the brief's I–VI outline preceded by Source
// overview. Per stage-prompt §3 (comparative-chapter exception), sources.anchor
// functions as sources.primary; the six anchors all resolve in sources.yaml.

=== Source overview

This chapter is a comparative-typology synthesis chapter rather than a primary-source narrative chapter; it draws on two layers of evidence — (1) the per-tradition area-specialist anchors that ground the two strong cases and the one minor reflex (te Velde 1967 and Faulkner 1972 for the Egyptian Ra-Apep corpus, with Faulkner's 1936–38 JEA editions of the Bremner-Rhind papyrus for the ritual-embedding material; Hoffner 1998 and Beckman 1982 for the Hittite Illuyanka tablets and the *purulli* festival; Fontenrose 1959 for the Apollo-Python Delphic combat and the *Septerion* re-enactment), and (2) the conceptual-comparative anchor that supplies the maʿat / isfet framework on which the chapter's analytical through-line rests (Assmann 2001).footnote:[Per brief 36-C3-cyclical-maintenance.yaml sources.anchor on the six methodological-comparative anchors (Assmann 2001, te Velde 1967, Faulkner 1972, Beckman 1982, Hoffner 1998, Fontenrose 1959) and chapters_drawn_from on the three Part-I chapters (Chs 6, 12, 16) whose own area-specialist anchors carry the per-tradition narrative-claims layer; Assmann, J., *The Search for God in Ancient Egypt*, trans. D. Lorton (Ithaca: Cornell University Press, 2001), as the conceptual-comparative anchor whose maʿat / isfet framework supplies the chapter's analytical through-line.]
...
The Egyptian per-tradition anchors are te Velde 1967 (Apep-and-Seth synthesis), Faulkner 1972 / rev. 1985 (Book of the Dead spells 7, 39, 108), and Faulkner's 1936–38 JEA editions (Bremner-Rhind P. BM EA 10188, the *Book of Overthrowing Apep*); the conceptual-framework anchor is Assmann 2001 on the maʿat / isfet framework that the brief makes the chapter's through-line.footnote:[te Velde, H., *Seth, God of Confusion: A Study of His Role in Egyptian Mythology and Religion* (Leiden: Brill, 1967), chs. 3–4 on Apep as Ra's nightly adversary and Seth as Apep-slayer; Faulkner, R.O., *The Ancient Egyptian Book of the Dead*, rev. ed. (London: British Museum, 1985; orig. 1972), on Apep-rebuffing spells 7, 39, and 108; Faulkner, R.O., "The Bremner-Rhind Papyrus I–IV", *JEA* 22–24 (1936–38), on the *Book of Overthrowing Apep*.]
...
The Hittite per-tradition anchors are Hoffner 1998 (working English translation of CTH 321 in *Hittite Myths*, second edition) and Beckman 1982 (the philological *editio princeps* in *JANES* 14: 11–25); these together carry every claim about the two co-equal versions, the *purulli* festival framing, and the cult of the storm-god of Nerik.footnote:[Hoffner, H.A., *Hittite Myths*, 2nd ed., SBL Writings from the Ancient World 2 (Atlanta: Society of Biblical Literature, 1998), "Illuyanka" §§1–2 with framing colophons; Beckman, G., "The Anatolian Myth of Illuyanka", *Journal of the Ancient Near Eastern Society* 14 (1982): 11–25, the *editio princeps*.]
// EVIDENCE: source_id=hoffner-1998 ; loc=Illuyanka §§1-2
// EVIDENCE: source_id=beckman-1982-illuyanka ; loc=JANES 14: 11-25

The Greek-side anchor for the minor reflex is Fontenrose 1959 (*Python: A Study of Delphic Myth and Its Origins*, chs. 1–3), whose treatment of the *Septerion* festival as an eight-yearly re-enactment of the Python-slaying provides the chapter's principal evidence for a Mediterranean cult-foundation cyclical reflex; Ogden 2013 supplies the supporting Greek-and-Roman dragon-myth survey context.footnote:[Fontenrose, J., *Python: A Study of Delphic Myth and Its Origins* (Berkeley: University of California Press, 1959), chs. 1–3 on the Apollo-Python combat and on the *Septerion* festival as eightfold-cyclical re-enactment of the Python-slaying; Ogden, D., *Drakōn: Dragon Myth and Serpent Cult in the Greek and Roman Worlds* (Oxford: Oxford University Press, 2013), ch. 2, supporting survey context.]
...
The framing material on the tablets identifies the composition as the recitation belonging to the *purulli* festival, the Hittite annual spring observance at which the myth was performed; the named scribal author in the colophon is Kella, identified on the tablet as the priest who set down the recitation of the *purulli* festival.footnote:[Hoffner 1998, "Illuyanka" §1, opening colophon naming the *purulli* festival and the scribal author Kella; Beckman 1982, *JANES* 14: 11–25, on the on-tablet framing of the recitation.]
...
The cult of the storm-god of Nerik is closely tied to Hittite kingship: the king himself participated in the *purulli* festival, and royal documents register the storm-god of Nerik among the principal patron deities of the Hittite state, so that the *purulli* recitation has a double function — ritual-aetiological for the spring festival and royal-legitimating for the dynasty under whose authority the festival was performed.footnote:[Hoffner 1998, introduction to "Illuyanka", on the royal-religious dimension of the Nerik cult and on the king's participation in the *purulli*; per Forsyth 1987, ch. 3, on the royal dimension of the Hittite combat-tradition.]
...
The Watkins philological argument for Illuyanka as a Hittite reflex of the reconstructed Indo-European *HERO SLAY SERPENT* formula (the Hittite verb-and-object pairing *kuenta… illuyanka-* as cognate with Vedic *áhann áhim*) lies on a different comparative axis from the cyclical-maintenance argument and is deferred to C5 (Ch38); the present chapter's interest in Illuyanka is in the *purulli* embedding rather than in the IE poetic-formula reconstruction, and the two comparative readings are independent.footnote:[Watkins 1995, *How to Kill a Dragon*, ch. 46, on Illuyanka as a Hittite reflex of the IE *HERO SLAY SERPENT* formula and on the *kuenta… illuyanka-* pairing; per the cross-reference to Part II C5 (Ch38) for the IE-philological argument that the present chapter does not develop.]
...
The Levantine Baal-Yamm and the Greek Zeus-Typhon combats are sovereignty-establishing once-and-done events whose annual recitation, where attested, commemorates rather than re-enacts; the Vedic Indra-Vṛtra combat is performed in ritual recitation but the Rigvedic frame is not that Indra has to re-kill Vṛtra each year for the cosmos to continue, even though the *áhann áhim* formula is recurrently sung — the formula's recurrence is poetic-liturgical rather than cosmologically constitutive in the Egyptian sense.footnote:[Per scope.md §"Subject definition" on the sovereignty-subtype examples and on the structural distinction between commemorative recitation and constitutive re-enactment; Assmann 2001, on the contrastingly constitutive character of the Egyptian daily combat.]
// EVIDENCE: source_id=assmann-2001-search ; loc=chs. on solar theology (constitutive-vs-commemorative)

The selection-criterion that the chapter applies is therefore tightly drawn: the cyclical-maintenance subtype requires (1) explicit on-tradition framing of the combat as recurring on a fixed schedule, (2) explicit on-tradition framing that the cosmos's continuance is contingent on the recurrence, and (3) preserved liturgical material that re-enacts the combat as a ritual act rather than commemorates it as a sealed event — a triple criterion that Egypt satisfies on all three counts (Bremner-Rhind, daily; Assmannian doctrine; effigy-destruction rite), the Hittite case satisfies on all three (CTH 321, annual; *purulli* prosperity-and-cosmic-order framing; festival recitation as verbal score), and most other traditions miss on at least one.footnote:[Assmann 2001, *The Search for God in Ancient Egypt*, on the three-feature structural pattern of the Egyptian case; Hoffner 1998 introduction to "Illuyanka" and Beckman 1982 *JANES* 14: 11–25 on the three-feature pattern of the Hittite case; per brief 36-C3-cyclical-maintenance.yaml structure section V on the selection-criterion as load-bearing for the chapter's case-selection.]
...
=== VI. The conceptual apparatus — *maʿat* / *isfet*

The brief makes Assmann's analysis of the Egyptian *maʿat* / *isfet* opposition the chapter's conceptual through-line on the grounds that the Egyptian framework is the book's clearest native concept-pair for combat-as-maintenance and is useful for articulating what "chaos" is *not* doing in the cyclical-maintenance subtype.footnote:[Per brief 36-C3-cyclical-maintenance.yaml structure section VI on Assmann's *maʿat* / *isfet* analysis as the chapter's conceptual through-line; Assmann 2001, *The Search for God in Ancient Egypt*, on the *maʿat* / *isfet* opposition as the central cosmological-ethical category-pair of Egyptian religion.]
...
The opposition is structurally asymmetric rather than dualistic: *maʿat* is the positive condition Ra's daily journey preserves, *isfet* is its privation or violation that Apep's nightly assault threatens to impose, and the two are not co-equal cosmic principles but order and its violation — a structure that grounds the cyclical-maintenance subtype in a way that a symmetric good-vs-evil dualism could not.footnote:[Assmann 2001, *The Search for God in Ancient Egypt*, on the asymmetric structure of the *maʿat* / *isfet* opposition; te Velde 1967, *Seth, God of Confusion*, ch. 3, on the same asymmetry as it underlies the Apep combat.]
// EVIDENCE: source_id=assmann-2001-search ; loc=chs. on maʿat and isfet

This asymmetry brings the *maʿat* / *isfet* framework into substantive contact with the Ballentine 2015 critique of the "chaos" half of the inherited Chaoskampf label: Apep is *isfet* — disorder, injustice, violation of order — not "chaos" in the inchoate-primordial-Western-philosophical sense, and the Egyptian framework supplies an articulate native-tradition vocabulary for the moral-political character that Ballentine argues the inherited "chaos" terminology obscures.footnote:[Ballentine 2015, *The Conflict Myth and the Biblical Tradition*, on the inadequacy of "chaos" as a category-term for the combat-myth adversaries; Assmann 2001, on *isfet* as a moral-political rather than metaphysically-inchoate category that articulates the alternative more clearly than any other native-tradition concept-pair the book engages.]
...
The structural contrast with C4 (eschatological displacement) is best articulated in *maʿat* / *isfet* terms: in the cyclical-maintenance subtype the cosmos is held in being by the daily-or-annual containment of *isfet* — Apep is rebuffed nightly, Illuyanka is recurrently slain — and the containment is interminable; in the eschatological subtype the cosmos's *isfet*-content (using the Egyptian framework as comparative analytic, not as native vocabulary for the eschatological traditions, which articulate the same structure in their own terms) accumulates toward a final reckoning, and the closure-combat at the end of cosmic time is the moment at which the *isfet* is finally and fully extinguished, after which the cosmos either ends (Ragnarök) or is renewed in a perfected condition (Frashokereti).footnote:[Assmann 2001, *The Search for God in Ancient Egypt*, on the interminable-containment structure of the cyclical-maintenance subtype; per Yarbro Collins 1976 and the eschatological-closure framing to be developed in C4 (Ch37).]
...
// Checks passed: yaml-and-adoc structure; 65 footnotes / 78 EVIDENCE
//   tokens (with three new doubled-token additions for Forsyth/Lambert/
//   Watkins per FIND-02/03/04); all 10 source_ids resolve in sources.yaml
//   (now also forsyth-1987, lambert-2013, watkins-1995 — already resolved
//   but newly tokenised); all 11 COMPARATIVE-HOOK chapter-numbers resolve
//   in toc.yaml; all 4 markers (1 SPECULATION, 1 VARIANT, 1 LACUNA, 2
//   INFERENCE) preserved verbatim with required pipe-fields.
// Findings applied (all 5 MEDIUM + all 3 LOW; 2 NOTEs are positive
// structural observations and require no fix):
//   FIND-01 ACCEPT: Teshub-Illuyanka → Tarḫunna-Illuyanka in 4 places
//     (chapter-comment, central-argument paragraph, §III title, §III
//     opening); §III opening parenthetical reformulated to make the
//     Hittite-vs-Hurrian distinction explicit.
//   FIND-02 ACCEPT: added // EVIDENCE: source_id=lambert-2013 ; loc=on
//     akītu recitation context after the §V Marduk-Tiamat paragraph.
//   FIND-03 ACCEPT: added // EVIDENCE: source_id=forsyth-1987 ; loc=ch. 3
//     after the §III Hittite-kingship-Nerik paragraph.
//   FIND-04 ACCEPT: added // EVIDENCE: source_id=watkins-1995 ; loc=
//     Part V chs. 44-48 after the §V Aži Dahāka paragraph.
//   FIND-05 ACCEPT: added comparative-analytical-vocabulary caveat to
//     §VI line 254 isfet-extension to eschatological-tradition materials.
//   FIND-06 ACCEPT: §III Version-1 Hupasiya bargain rephrased per Ch6
//     upstream sequence (bargained-night → concealment → binding).
//   FIND-07 ACCEPT: §III Version-2 renewed combat now restored to the
//     "at the sea" locus per Ch6 line 205.
//   FIND-08 ACCEPT: [LACUNA:] block "Faulkner's four-part *JEA* edition"
//     now reads "(Parts I-IV across *JEA* 22, 23, and 24)".
//   FIND-09 NOTE — no fix required (positive observation: maʿat/isfet
//     discipline PASS).
//   FIND-10 NOTE — no fix required (positive observation: cyclical-vs-
//     eschatological boundary-work PASS).
```

---

# Input file: briefs/36-C3-cyclical-maintenance.yaml
...
chapters_drawn_from:
  ...
  - ch-06-illuyanka
  # Supporting:
  - ch-12-greek-dragons-after-typhon  # Apollo Septerion festival, a cult-foundation reflex

comparative_argument: |
  A small but tight cluster. Ra versus Apep is a daily combat preserved in priestly liturgy
  (Bremner-Rhind Book of Overthrowing Apep); Teshub versus Illuyanka is an annual combat
  explicitly framed as the aetiology of the purulli spring festival. In both cases the
  combat is never concluded — it is re-performed. This marks a distinct subtype from
  cosmogonic (one-time, generative) and sovereignty (episodic, terminal) combats: cyclical
  maintenance is combat-as-ritual-preservation, where the cosmos is always under threat
  and the ritual is the insurance. The Apollo Septerion festival at Delphi is a minor
  reflex of the same subtype.

sources:
  anchor:
    - id: assmann-2001-search
      loc: "maʿat/isfet framework as the conceptual anchor"
    - id: te-velde-1967
      loc: "on Apep-combat ritual"
    - id: faulkner-1972-bod
      loc: "on the Bremner-Rhind liturgy"
    - id: beckman-1982-illuyanka
      loc: "on the purulli festival"
    - id: hoffner-1998
      loc: "on Illuyanka's ritual framing"
    - id: fontenrose-1959
      loc: "on the Septerion festival"

structure:
  - section: "I. The pattern"
    summary: "Combat-as-recurring-ritual. Neither one-time cosmogony nor episodic sovereignty succession — the combat is the rite's repeating center."
  - section: "II. Ra and Apep — daily"
    summary: "The Bremner-Rhind liturgy; the Amduat / Book of Gates nocturnal registers; the practice of Apep-figurine wax-melting."
  - section: "III. Teshub and Illuyanka — annual"
    summary: "The purulli spring festival at Nerik; the two co-equal tablet-versions as possibly ritual-performance alternates."
  - section: "IV. Apollo and Python — the cult-foundation-with-festival cognate"
    summary: "Septerion's re-enactment of the Python-slaying every eighth year is not chaoskampf strictly but a related pattern: combat-as-cult-preservation."
  - section: "V. Why these two and not others"
    summary: "Marduk's combat is liturgised at akītu, but it is narrated as one-time; the akītu is recitation, not re-enactment. The Zoroastrian pattern is eschatological rather than maintenance-cyclical. Cyclical maintenance is specifically where the ritual's effectiveness depends on this-time's combat."
  - section: "VI. The conceptual apparatus — maʿat / isfet"
    summary: "Assmann's analysis: the Egyptian framework is the book's clearest native concept-pair for combat-as-maintenance. Useful for articulating what 'chaos' is NOT doing here."
...
special_instructions: |
  Short chapter by design. The cyclical-maintenance subtype has only two strong attestations
  and one minor one. Do not pad. The chapter's theoretical contribution is showing that
  combat-myth + ritual-recurrence is a distinct and differently-functioning subtype, not a
  "weaker cosmogony". Assmann's maʿat/isfet framework is the chapter's conceptual through-line.
  The chapter should explicitly set up the contrast with C4 (eschatological): Egypt has no
  eschatology; the combat is perpetual. Revelation has an eschatology; the combat is final.
  These differ structurally.
```
