...
# Book: chaoskampf
# Generated: 2026-04-28T12:32:54Z
...
# Input file: chapters/18-thor-jormungandr.claims.approved.adoc
...
The chapter's Eddic primary text for Thor's fishing expedition is *Hymiskviða* ("The Lay of Hymir"), an Eddic poem of approximately forty stanzas in *fornyrðislag* metre that narrates Thor's journey to the giant Hymir's hall to fetch a brewing-cauldron and his rowing-out with Hymir to fish for the world-encircling serpent.footnote:[Larrington 2014, headnote and translation of *Hymiskviða*, on the poem's approximate length (around forty stanzas; the standard Neckel-Kuhn edition counts 38 complete stanzas plus one partial), its *fornyrðislag* metre, and its narrative arc from cauldron-quest to fishing expedition.]
// EVIDENCE: source_id=larrington-poetic-edda ; loc=Hymiskviða headnote

The chapter's Eddic primary text for the eschatological combat is *Völuspá* ("The Seeress's Prophecy"), the opening poem of the *Codex Regius* and the principal Eddic source for the Norse cosmogony and eschatology, in which the Thor-and-Jörmungandr Ragnarök combat is named and compressed in stanza 56 of the Larrington 2014 edition.footnote:[Larrington 2014, headnote and translation of *Völuspá* with attention to the Ragnarök sequence at stanzas 50–58, and specifically to stanza 56 on the Thor-and-Jörmungandr combat.]
...
The Norse cosmography is structured by a tripartite vertical-and-horizontal scheme: the world-tree Yggdrasil at the centre, with Ásgarðr (the realm of the gods) above, Midgard (the world of humans) at the middle level surrounded by the ocean and the encircling serpent, and Útgarðr (the "outer enclosure", realm of the giants) and Niflheimr / Hel beyond.footnote:[Faulkes 1987, *Gylfaginning* chs. 8, 14, 34, on the tripartite Norse cosmography (Ásgarðr, Miðgarðr, Útgarðr / Niflheimr) organised around Yggdrasil and on the encircling-serpent's position at the boundary between Miðgarðr and the outer realms.]
...
The remainder of *Hymiskviða* (sts. 25 to the close of the poem) returns to the cauldron-quest frame-narrative: Thor and Týr take the great cauldron from Hymir's hall (after a contest of strength involving the breaking of Hymir's drinking-cup against the giant's head), are pursued by Hymir and his giant-kin, and Thor slays the pursuing giants with Mjöllnir on the shore before returning with the cauldron to the gods.footnote:[Larrington 2014, *Hymiskviða* sts. 25 to end, on the resolution of the cauldron-quest frame, on the breaking of Hymir's drinking-cup, on the pursuit by Hymir's giant-kin, and on Thor's killing of the giants on the shore.]
// EVIDENCE: source_id=larrington-poetic-edda ; loc=Hymiskviða sts. 25 to end
...
[VARIANT: primary=Hymiskviða sts. 23–24 / Gylfaginning 48 (Larrington 2014; Faulkes 1987), serpent escapes when Hymir cuts the line before the killing blow | alt=Húsdrápa fragments (Faulkes 1987 Skáldskaparmál citations), serpent appears to be beheaded by Thor before the line is cut | chosen: both variants are presented co-equally per the brief; neither the Hymiskviða / Gylfaginning line-cut outcome nor the Húsdrápa apparent-killing outcome is privileged as the canonical version, and the chapter presents both as live witnesses from different textual strata | reason: per brief 18-thor-jormungandr.yaml variants.classification: co-equal (no single source has all three encounters fully narrated); per brief alternates listing the Húsdrápa-beheading as a variant outcome of the fishing encounter; Larrington 2014 and Faulkes 1987 both record the line-cut outcome but Faulkes 1987 also preserves the *Húsdrápa* fragments that imply the beheading.]
...
The third encounter is the only one of the three in which the killing actually takes place: in the Útgarðaloki encounter the serpent is lifted-but-not-killed; in the fishing encounter the serpent is hooked-but-(in the Hymiskviða / Gylfaginning reading)-released — or, in the *Húsdrápa* fragments, apparently struck before the line is cut; in the Ragnarök encounter the serpent is killed-and-Thor-also-dies, completing the layered sequence with the deferred mutual killing.footnote:[Faulkes 1987 *Gylfaginning* chs. 47, 48, 51; Larrington 2014 *Hymiskviða* sts. 22–24 and *Völuspá* st. 56; per brief 18-thor-jormungandr.yaml on the layered three-encounter completion-structure.]
...
// Checks passed: footnote+evidence-pair (142/142), source_id-whitelist, glossary-discipline, markers-valid
// Fixes applied: FC-01 MEDIUM (VARIANT marker at line 261 — internal contradiction stripped: removed "with the Hymiskviða / Gylfaginning outcome treated as the dominant one in the surviving narrative tradition" from the chosen sub-field; replaced with co-equal framing "neither the Hymiskviða / Gylfaginning line-cut outcome nor the Húsdrápa apparent-killing outcome is privileged as the canonical version, and the chapter presents both as live witnesses from different textual strata"; line 348 also softened — "in the dominant Hymiskviða / Gylfaginning reading" → "in the Hymiskviða / Gylfaginning reading" with explicit Húsdrápa alternate noted, eliminating priority drift across the document); FC-02 MEDIUM (line 35 source-overview claim — "stanzas 55 and 56 of the Larrington 2014 edition" → "stanza 56 of the Larrington 2014 edition", aligning the body claim with the brief's anchor and with the document's own footnote and all subsequent citations of Völuspá st. 56); FC-03 MEDIUM (line 32 Hymiskviða stanza count — "thirty-nine-stanza Eddic poem" → "Eddic poem of approximately forty stanzas"; footnote softened to note the standard Neckel-Kuhn count of 38 complete stanzas plus one partial; line 249 "sts. 25–39" → "sts. 25 to the close of the poem" / "sts. 25 to end" for consistency with the unverifiable-precise-count discipline); FC-04 LOW (body-prose Miðgarðr → Midgard per glossary 957–961: line 102 first mention introduces both forms as "Midgard (Old Norse Miðgarðr)"; lines 126, 132, 138 body-prose occurrences converted to "Midgard"; line 129 etymological gloss "Miðgarðr is the 'middle enclosure'" preserved as philological note; Miðgarðsormr lexeme preserved throughout; all footnote/philological occurrences of Miðgarðr left unchanged).
// Flagged-only: FC-05 NOTE (nine-paces double-attribution to Völuspá 56 + Gylfaginning 51 is correct; both sources contain the detail; Völuspá st. 56 includes "nine steps goes Fjörgyn's son" and Gylfaginning 51 is the prose expansion — no fix required, double-attribution preserved as written).
// Warnings: none. Banned umbrella terms ("chaos-figure", "chaos-monster", "chaos-serpent") not present in body prose or footnotes.
```
