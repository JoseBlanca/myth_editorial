...
# Book: chaoskampf
# Generated: 2026-05-02T05:57:02Z
...
registry:
  ...
  - id: johnston-ojibway-heritage
    ...
    notes: "Insider Anishinaabe overview of cosmology, manitous, and the Nanabozho cycle; anchors the emic frame against which the chaoskampf reading is judged. Identifier provisional pending factcheck verification (Ch27/Ch30 source-pinning precedent)."
  ...
  - id: johnston-manitous
    ...
    notes: "Anishinaabe-authored treatment of manitous including Mishipeshu and Nanabozho; supports a relational rather than combat-cosmogonic reading. Minnesota Historical Society Press paperback (ISBN 9780873514118, 2001) is a widely cited alternate edition. Identifier provisional pending factcheck verification."
  ...
  - id: smith-island-anishnaabeg
    ...
    notes: "Book-length study of the Thunderer / Underwater-manitou dialectic; key area-specialist source for reading Mishipeshu and the Thunderbirds as complementary rather than chaos-vs-order. Identifier provisional pending factcheck verification."
  ...
  - id: vizenor-narrative-chance
    ...
    notes: "Contains Vizenor's 'Trickster Discourse' essay; anchors the methodological refusal to subordinate Nanabozho to Western combat-myth or hero/villain typologies. Identifier provisional pending factcheck verification."
...
# Input file: chapters/31-vainamoinen-iku-turso.claims.adoc
...
The *Kalevala*'s Iku-Turso material is reshaped by Lönnrot from the laconic-and-fragmentary older rune material into a continuous and integrated episode within the *Kalevala*'s overall narrative architecture: Iku-Turso appears principally in the *Kalevala*'s 50th canto (in the 1849 *Uusi Kalevala* numbering) and in adjacent passages connected with the Sampo-cycle and the Pohjola material, with Lönnrot drawing on the older rune-tradition narrative-encounter material and on the incantation-against-sickness material to assemble a more extended and connected presentation than any single rune-tradition performance preserves, and with the *Kalevala*'s presentation integrated with the wider *Kalevala*'s arc rather than presented as a free-standing narrative episode.footnote:[Siikala 2002, on the *Kalevala*'s Iku-Turso material as reshaped by Lönnrot from the laconic-and-fragmentary older rune material into a continuous and integrated episode within the *Kalevala*'s overall narrative architecture; on Iku-Turso's principal appearance in the *Kalevala*'s 50th canto (in the 1849 *Uusi Kalevala* numbering) and in adjacent passages connected with the Sampo-cycle and the Pohjola material; on Lönnrot's drawing on the older rune-tradition narrative-encounter material and on the incantation-against-sickness material to assemble a more extended and connected presentation than any single rune-tradition performance preserves; on the *Kalevala*'s presentation as integrated with the wider *Kalevala*'s arc rather than presented as a free-standing narrative episode.]
// EVIDENCE: source_id=siikala-finnish ; loc=Mythic Images and Shamanism, chs. on Kalevala combat
...
# Input file: briefs/31-vainamoinen-iku-turso.yaml
...
chapter_type: "related (full, transformed-variant framing)"

sources:
  primary:
    - id: siikala-finnish
      loc: "Mythic Images and Shamanism, chs. on Kalevala combat"
      identifier: "ISBN 9789514109027"

variants:
  classification: co-equal
  summary: |
    Older rune-tradition witnesses are more laconic; Lönnrot's 1835 / 1849 Kalevala is a
    composite literary-editorial synthesis that expanded and reshaped the older fragments.
    The chapter presents BOTH layers — the older rune material AND Lönnrot's redaction —
    side by side, per scope-lock 2026-04-23 "transformed variant" framing.

summary: |
  The sea-monster Iku-Turso emerges from the sea; Väinämöinen subdues him by shamanic song
  rather than by sword. The encounter is a binding, not a slaying. The older rune material
  is laconic; Lönnrot's Kalevala expanded and integrated the material into the modern
  composite. The chapter treats both the older attestation and the Lönnrot editorial layer
  explicitly.

cultural_relevance:
  centrality: |
    Central in modern Finnish national consciousness (via the Kalevala); marginal in
    historical-attestation terms (the older rune material is more fragmentary than the
    Kalevala's prominence would suggest).
  function: |
    - Shamanistic-ritual (Väinämöinen's song as knowledge-and-subjugation rather than
      combat)
    - National-romantic (via Lönnrot's 19th-century project)
    - Didactic (the hero-sage as knowledge-holder rather than warrior)
  cross_cultural_parallels: |
    - The "subjugate-not-slay" transformation parallels Krishna-Kāliya (Chapter 15) —
      binding or taming rather than killing.
    - The knowledge-over-force framing is distinctively Finnic; no direct IE parallel.
    - Lönnrot's editorial synthesis raises methodological parallels with the Macpherson-
      Ossian question and the Ivanov/Toporov Perun-Veles reconstruction (Chapter 20): how
      much of "the tradition" is 19th-century nationalist reconstruction?

target_length_words: 4500

special_instructions: |
  The chapter must explicitly separate the older rune attestations from Lönnrot's 1835 /
  1849 editorial synthesis. Present the older material first (laconic, fragmentary) and
  then show how Lönnrot reshaped it into the Kalevala Iku-Turso episode. This two-layer
  framing is the chapter's contribution — Part II C8 (refusal and appropriation) picks up
  the methodological point about editorial synthesis. Area-specialist citation applies:
  cite Siikala by name throughout; note the broader scholarship on Lönnrot's compositional
  method (Honko, DuBois). The chapter does NOT claim Iku-Turso fits chaoskampf cleanly; the
  "transformed variant" framing is explicit.
```
