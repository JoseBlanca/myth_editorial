...
# Book: chaoskampf
# Generated: 2026-04-26T06:33:56Z
...
# Input file: chapters/07-baal-yamm-lotan.claims.approved.adoc
...
// Timestamp: 2026-04-26T06:05:30Z
...
# Input file: chapters/07-baal-yamm-lotan.adoc

```
[[ch-07-baal-yamm-lotan]]
== Baal vs. Yamm and the Defeat of Lôtan (the Ugaritic Baal Cycle)
...
Both volumes provide the Ugaritic text in transliteration, an English translation, and an extensive commentary in which philological cruxes, alternative readings, and the relevant secondary literature are discussed at line-by-line resolution.footnote:[Smith 1994, Vol. I introduction on editorial conventions; Smith & Pitard 2009, Vol. II introduction on editorial conventions.]
// EVIDENCE: source_id=smith-1994-baal-i ; loc=Vol. I introduction
The Smith and Smith & Pitard volumes are the definitive modern critical edition of the Cycle and the source of every primary-text claim in this chapter; sub-line readings beyond the column-level resolution are not reconstructed here, and any such finer-grained reading would be flagged UNVERIFIED.footnote:[Smith 1994, Vol. I full volume; Smith & Pitard 2009, Vol. II full volume.]
// EVIDENCE: source_id=smith-1994-baal-i ; loc=Vol. I full volume

The secondary literature anchoring the chapter's interpretive framework consists of five monographs that bracket the modern study of the Cycle from different directions. John Day's *God's Conflict with the Dragon and the Sea* (Cambridge, 1985) is the principal twentieth-century monograph on the continuity between the Ugaritic Baal-Yamm and Baal-Lôtan material and the Hebrew Bible's Yahweh-vs-Sea / Yahweh-vs-Leviathan corpus.footnote:[Day 1985, chs. 1–3 on the Baal Cycle and its Hebrew Bible reception.]
// EVIDENCE: source_id=day-1985 ; loc=chs. 1-3
Debra Scoggins Ballentine's *The Conflict Myth and the Biblical Tradition* (Oxford, 2015) is the principal recent monograph arguing that "chaos" is the wrong category for Yamm and his Hebrew Bible cognates, with the Baal-Yamm combat as her central test case for a rival-sovereignty rather than chaos-vs-order reading.footnote:[Ballentine 2015, ch. 2 on Baal-Yamm as rival-sovereignty combat.]
// EVIDENCE: source_id=ballentine-2015 ; loc=ch. 2
Neil Forsyth's *The Old Enemy* (Princeton, 1987) treats the Ugaritic material as a station in the long history of the combat-myth from Sumer through Christian apocalyptic, with chapter 3 covering the Levantine evidence.footnote:[Forsyth 1987, ch. 3 on the Ugaritic material.]
...
Two features of this dossier set the framing for everything that follows. The first is that a single named scribe, working under royal patronage and priestly supervision, has left a coherent group of six tablets from a known building in a known city, recovered together by archaeologists who can date the destruction layer in which the find was made. The second is that the Cycle's narrative work, as the editors have come to read it across a century of philological labour, is not the creation of the world from prior matter but the redistribution of office and authority within an already-existing divine assembly. The chapter is built around that second feature.
...
The cast assembled here matters for what is to come. El presides; Baal stands among El's sons and clients; Yamm sits in the same assembly as a god whose name is the word for "sea"; Mot sits in the same assembly as a god whose name is the word for "death." Kothar runs the forge that supplies the assembly's weapons and architecture. ʿAnat and Athtart fight alongside Baal. Athirat speaks for the senior matron's interest. The action of the Cycle moves these named figures through council, embassy, combat, and palace-building, and the result is the redistribution of an already-extant office of kingship from one of El's sons to another. That is the institutional grammar within which Baal's combat with Yamm has to be read.

Two implications of this setup deserve to be marked at the outset, because they shape every subsequent reading. The first is that Yamm and Mot are not outsiders. They sit on the same benches as Baal, they answer to the same El, they are addressed by the same titles of son and beloved that the assembly bestows on its other members. The Cycle's later combats are therefore not, on the on-text reading the editors have arrived at, contests across a boundary between the divine and the non-divine, but contests across the offices and prerogatives that the divine assembly distributes among its members. The second is that the divine architecture is not a single throne. There is El, who presides, and there is whoever holds the kingship El authorises, and there are the territorial residences and titles that go with the kingship, and the Cycle's narrative is concerned with the second of those — the kingship-that-is-distributed, not the presiding-office-that-distributes-it. That distinction will hold throughout the body of the chapter, and the Gunkel-Ballentine debate later in the chapter turns in large part on whether one has registered it.
...
The narrative shape that emerges from KTU 1.1 and 1.2 in their reconstructed order is therefore an internally consistent piece of divine-court politics. El proposes a king; the assembly defers; the proposed king's first act is a vassal-demand on a peer god; the peer god refuses, and the refusal escalates from words in the assembly chamber to combat with named weapons; the combat ends in the demoted king's collapse, not annihilation; the assembly then ratifies the transfer of the office. Every load-bearing element of the surviving narrative — the renaming, the embassy, the ymlk acclamation, the post-combat scattering verb — is drawn from the same juridical lexicon. This is the framework that the next movement of the Cycle, the palace-building cycle of KTU 1.3–1.4, takes up.

It is worth pausing on the two-mace combat as a piece of narrative engineering, because it does work that the rest of the movement assumes. The combat is structured so that the first instrument is insufficient and the second is decisive, which means that the combat-poetry has space for two separately addressed weapons, two separately delivered blows, and two separately registered effects on the rival's body — shoulders for the first, skull for the second. That structure gives Kothar's forge a function the narrative does not allow him to skip: the named-mace pair is the technical precondition for the combat's outcome, and the Cycle's craftsman-god is therefore positioned at the fulcrum of the kingship-transfer. The same craftsman will later build Baal's palace, and the continuity is not decorative. The forge that produces Yagrush and Ayyamur is the forge that will produce the cedar-and-silver palace on Ṣapānu, and the assembly's grant of the kingship to Baal is mediated, at both ends of the movement, by the same set of hands.

The role of the messenger episode, similarly, deserves to be noted as a structural piece. Yamm's demand reaches the assembly through ambassadors who deliver it in the formal markers of vassalage, and Baal's defiance is registered as a striking-action against those ambassadors that ʿAnat and Athtart restrain. The grammatical effect is to mark the combat's onset twice: once in the assembly chamber, where the diplomatic frame is broken; and once on the open ground of the combat itself, where the maces leap from Baal's hand. The repetition is not redundant. It tells the reader that the combat is a continuation by other means of the assembly-floor refusal, and that the frame within which the maces will land is the frame the messengers' speech opened.
...
The two movements of the Cycle taken together — combat at KTU 1.1–1.2 and palace-building at KTU 1.3–1.4 — therefore divide the work of establishing Baal's kingship into a phase of contest and a phase of formalisation. The first phase removes the rival; the second phase fits the victor with the institutional furniture of the office. The same juridical vocabulary runs through both: assembly, petition, audience, authorisation, gift-exchange, banquet. The same craftsman runs through both: Kothar's hands turn out maces in tablet 2 and turn out a cedar-and-silver palace in tablet 4. The same geographical anchor terminates the second phase that the combat in the first phase set in motion: Baal moves from the assembly's floor to the heights of Ṣapānu, and the storm-god's voice from the window over the mountain is the audible token that the kingship has settled. None of this is cosmogonic. The world the assembly inhabits at the end of Movement II is the world it inhabited at the beginning of Movement I, with one office reassigned and one residence newly built.
...
The discipline imposed by the brief on this section is a piece of methodological hygiene worth being explicit about. There exists, in the wider literature, a temptation to import the Hebrew Bible's Yahweh-vs-Leviathan combat narratives back into the Ugaritic side of the chain on the strength of the linguistic cognancy and the shared seven-headed-serpent topos. The temptation is intelligible — the cognancy is real, and the topos travels — but yielding to it would manufacture a Ugaritic narrative that the surviving tablets do not preserve. What the tablets do preserve is a name, a set of epithets, a head-count, and an embedded retrospective allusion in another god's taunt-speech. That is the on-text Ugaritic material, and it is the only Ugaritic material the chapter narrates at this point. The chain that runs from ltn through to lwytn is real, but the narrative load on the Ugaritic end is borne by the Baal-Yamm material; the Lôtan reference enters the Cycle as a name, not as a story.
...
The Baal-Mot material is also the immediate setting in which the Lôtan reference is delivered: it is Mot's taunt, in the opening lines of KTU 1.5 i, that introduces the named figure Lôtan into the Cycle's surviving textual record.footnote:[Smith & Pitard 2009, Vol. II, KTU 1.5 i commentary on the Mot-speech setting of the Lôtan reference.]
// EVIDENCE: source_id=smith-pitard-2009-baal-ii ; loc=KTU 1.5 i commentary
The agricultural-calendar reading of the Baal-Mot material — Baal's death-and-revival as a mythic articulation of the seasonal alternation between the wet productive season and the dry season — has wide currency in the secondary literature, but Smith and Pitard caution that the Cycle's text does not present it as a calendrical-ritual aetiology in the same explicit way that, for example, the Hittite _purulli_ recitations frame the Illuyanka combat.footnote:[Smith & Pitard 2009, Vol. II introduction on the cautious treatment of the agricultural-calendar reading.]
// EVIDENCE: source_id=smith-pitard-2009-baal-ii ; loc=Vol. II introduction

The position taken here is therefore that the Baal-Mot material is a separate narrative phase of the Cycle from the Baal-Yamm combat, that its register is cosmic-political negotiation rather than serpent-combat, and that its principal contribution to the present chapter is to provide the speech-context within which Mot's retrospective taunt at KTU 1.5 i 1–3 names Lôtan. The chapter does not narrativise the Baal-Mot material because the brief reserves that material for specialist treatment, and because importing it into a chaoskampf chapter would mis-categorise its register. What the chapter retains is the structural fact that the Lôtan reference comes embedded in a Mot-speech, and that Mot's speech is itself part of a separate Baal-vs-Mot phase of the Cycle, not a continuation of the Baal-vs-Yamm combat.
...
The accumulated weight of Ballentine's four observations is therefore best read as a recalibration rather than a refutation. Yamm's name is the common noun for "sea." El's first act in the surviving narrative is to grant Yamm the kingship and to invite the assembly to confer a throne-name on him. The post-combat narrative goes on to install Baal in a palace, not to fashion the cosmos from the rival's body. The epithet pair Yamm / Judge River gives the rival a juridical office that no chaos-figure can hold. None of these observations is new to Ugaritic philology. Smith's volume-I introduction had registered the kingship-as-spine reading independently of Ballentine, and Forsyth's chapter 3 had registered the sovereignty-not-cosmogony point earlier still. What Ballentine 2015 does is gather those observations into a single argument and use them to challenge the application of the inherited Chaoskampf vocabulary to the on-text Ugaritic material. The chapter's adoption of that argument is therefore in line with the trajectory of the secondary literature itself, not an innovation imposed on it.
...
The triangulation that closes the chapter is worth restating in plain terms. Backward from Ugarit, the Marduk-Tiamat material in Mesopotamian Enūma Eliš shares a structural inventory with the Baal Cycle — storm-god, named adversary, post-combat institutional consolidation — without either text being derivable from the other. Forward from Ugarit, the Hebrew Bible's Yahweh-vs-Leviathan and Yahweh-vs-Rahab passages preserve, on Day 1985's reading, the linguistic and motivic specificity of the Ugaritic Baal-Yamm and Baal-Lôtan material, with ltn ↔ lwytn as the most specific lexical token. Laterally from Ugarit, the Hesiodic Zeus-vs-Typhon combat reaches the Greek poets through Phoenician intermediaries during the Orientalising horizon, on the West and Burkert reading, and the Baal-Yamm material is one of the inputs that journey carries. None of these three reception arcs requires the cosmogonic-chaos framing as its structuring frame, and the chapter's substantive position — that Baal-Yamm is a rival-sovereignty combat in the on-text Ugaritic material — is compatible with each of them.
