...
# Book: chaoskampf
# Generated: 2026-04-30T19:32:44Z
...
# Input file: chapters/27-mapuche-kai-tren.claims.approved.adoc
...
// while acknowledging regional variation. Koessler-Ilg 1954 (Cuentan los
...
// Checks passed: footnote+evidence-pair (23/23), source_id-whitelist, glossary-discipline, markers-valid
// Fixes applied: FC-01 MEDIUM (identifier-mismatch, Foerster ISBN — ACCEPT per Ch20 FC-03 / Ch24 FC-03 precedent: sources.yaml and the 8 EVIDENCE-anchored footnotes citing foerster-religiosidad-mapuche updated from ISBN 9789561109315 to ISBN 9789561109124 per the auditor's research consensus across AbeBooks, Amazon, University of Chile repository, buscalibre.cl, serindigena.org, and the University of Chicago catalog record. The discrepancy was a digit-transposition data-entry error. Content plausibility is unaffected — Foerster 1993 remains the correct anchor for all 8 cited claims.); FC-02 LOW (identifier-mismatch, Course ISBN — ACCEPT paperback per Ch20 FC-03 precedent: sources.yaml and the 2 EVIDENCE-anchored footnotes citing course-becoming-mapuche updated from ISBN 9780252078163 to ISBN 9780252078231 (paperback edition per University of Illinois Press catalogue and Amazon). The hardcover ISBN 9780252036477 was an alternative; the paperback is the more accessible standard and follows the project precedent of pinning the more widely circulated edition for non-rare twentieth- and twenty-first-century scholarly anchors. Content plausibility is unaffected — Course 2011 remains the correct anchor for the personhood-and-cosmological-framework claims.); FC-03 LOW (identifier-mismatch, Faron OCLC — ACCEPT per Ch20 FC-03 precedent: sources.yaml and the 1 EVIDENCE-anchored footnote citing faron-hawks-of-sun updated from OCLC 247070 (unverified) to OCLC 320079821 (the dominant WorldCat record per the auditor's verified search at https://search.worldcat.org/es/title/Hawks-of-the-sun-:-Mapuche-morality-and-its-ritual-attributes/oclc/320079821). Content plausibility is unaffected — Faron 1964 remains the correct structural-ritual anchor.); FC-04 LOW-MEDIUM (identifier-mismatch, Koessler-Ilg edition — MODIFY per Ch20 FC-03 precedent: sources.yaml entry koessler-ilg-cuentan title kept as *Cuentan los araucanos: Mitos, leyendas y tradiciones* but publisher / year / OCLC swapped from "Buenos Aires: Editorial Mar Océano, 1962; OCLC 4124869" to "Buenos Aires: Espasa-Calpe, Colección Austral no. 1208, 1954" per web-search confirmation that the 1954 Espasa-Calpe Austral edition is the canonical scholarly citation for the work (Argentina mincyt repository entry: "Koessler-ILG, Berta: Cuentan los araucanos. Ed. Espasa-Calpe, Colección Austral. Buenos Aires, 1954. 153 págs.") and that no 1962 Mar Océano edition could be independently confirmed. The OCLC identifier is dropped pending confirmation; the year-and-publisher correction is the load-bearing fix. The 10 EVIDENCE-anchored footnotes citing koessler-ilg-cuentan are updated to "Koessler-Ilg 1954" body-prose references and to the 1954 Espasa-Calpe publisher-and-year metadata in the source-overview footnotes. The body-prose claim that references "Koessler-Ilg's compilation expanding her earlier German-language *Märchenerzähler ohne Buch* of 1928" remains correct since the 1954 edition expands the 1928 German original; only the citation metadata changes. Content plausibility is unaffected — Koessler-Ilg's Mapuche oral-narrative compilation remains the foundational Spanish-language anchor for the Kai-Kai / Tren-Tren cycle in either case.).
// Sources.yaml additions: 0 new entries for Ch27. In-place updates: 4 identifier-corrections — foerster-religiosidad-mapuche identifier_value (ISBN 9789561109315 → 9789561109124); course-becoming-mapuche identifier_value (ISBN 9780252078163 → 9780252078231); faron-hawks-of-sun identifier_value (OCLC 247070 → 320079821); koessler-ilg-cuentan year (1962 → 1954), full_citation publisher (Editorial Mar Océano → Espasa-Calpe, Colección Austral no. 1208), and identifier_value (OCLC 4124869 dropped pending confirmation, identifier_type changed from OCLC to LCCN-pending or removed per project convention). Source count unchanged (66 entries).
// Briefs / governing-document changes: briefs/27-mapuche-kai-tren.yaml UPDATED to mirror the 4 sources.yaml identifier corrections (foerster identifier "ISBN 9789561109315" → "ISBN 9789561109124"; course identifier "ISBN 9780252078163" → "ISBN 9780252078231"; faron identifier "OCLC 247070" → "OCLC 320079821"; koessler-ilg identifier "OCLC 4124869" updated to reflect the 1954 Espasa-Calpe Austral edition).
// Warnings: none. Banned umbrella terms ("chaos-figure", "chaos-monster", "chaos-serpent") not present in body prose, footnotes, markers, or COMPARATIVE-HOOK comments. Glossary discipline holds (Kai-Kai / Tren-Tren, Wenu Mapu, Naq Mapu, Minche Mapu, ngen, wekufü, machi, ngillatun, nguillatuwe, filu, Mapudungun, Nguluche, Huilliche, Pehuenche, pehuén / Araucaria araucana in conventional scholarly forms throughout). Forsyth disclaimer wording at line 47 verified as correct per Ch23/Ch24-onwards precedent — the single Forsyth EVIDENCE token correctly characterises Forsyth as the long-arc combat-myth typology framing anchor with explicit "not for Mapuche-coverage scholarly coverage" disclaimer; no further fix required. APPROPRIATION-FLAG marker at line 109 verified as complete per the four-component checklist (named area specialists Foerster/Bacigalupo/Course/Faron with Latcham named-but-flagged; substance of cosmogonic-cataclypse objection; tier implication; C7/C8 forwarding clause; comparable-to-Ch26 / milder-than-Ch32 spectrum positioning) per the auditor's appropriation_flag_check section. Source-overview register: technical-academic per the chapter's related-tier short/family requirements; no register-softening applied since the audit's findings did not flag overview register, and the user-feedback memory's "Source overviews too academic" note is for future books rather than retroactive softening of an already-fact-checked related-tier chapter at post-human-normalize.
```

---

# Input file: briefs/27-mapuche-kai-tren.yaml
...
chapter_type: "related (short/family)"

sources:
  primary:
    - id: koessler-ilg-cuentan
      loc: "Cuentan los araucanos, sections on Kai-Kai / Tren-Tren and the flood-and-height cosmogony"
      identifier: "stable-url: https://repositoriosdigitales.mincyt.gob.ar/vufind/Record/BDUNCU_f331a4b9b4ecdd61224cf08ff45c49bd (1954 Espasa-Calpe Austral edition)"
  secondary:
    - id: foerster-religiosidad-mapuche
      loc: "Introducción a la religiosidad mapuche, on the Wenu / Naq / Minche Mapu cosmographic system and ngillatun ritual"
      identifier: "ISBN 9789561109124"
    - id: bacigalupo-shamans-foye
      loc: "Shamans of the Foye Tree, on machi and contemporary Mapuche ritual"
      identifier: "ISBN 9780292716599"
    - id: course-becoming-mapuche
      loc: "Becoming Mapuche, on Mapuche personhood and the cosmological framework of ritual"
      identifier: "ISBN 9780252078231"
    - id: faron-hawks-of-sun
      loc: "Hawks of the Sun, on the structural-ritual framework"
      identifier: "OCLC 320079821"
    - id: forsyth-1987
      loc: "combat-myth long-arc typology (Sumer through Judeo-Christian apocalyptic); not for Mapuche-specific coverage"
      identifier: "ISBN 9780691014746"

source_anchoring_notes: |
  Five Mapuche-specific anchors were pinned in sources.yaml at the start of this
  chapter-claims cycle (commit pending), resolving the inventory.approved.yaml
  identifier_missing flag for the mapuche-kai-tren entry. The principal narrative
  anchor is Koessler-Ilg 1962 (Cuentan los araucanos); Foerster 1993, Bacigalupo
  2007, Course 2011, and Faron 1964 are secondary area-specialist anchors used
  for the cosmographic / ritual / appropriation-framing material. Earlier
  ethnographic compilations (Latcham 1924; Lenz; Augusta-Moesbach 1934-1936)
  and colonial-period Spanish witnesses (Rosales SJ ~1670; Núñez de Pineda
  ~1673) are not yet pinned; they may be added at chapter-draft if a specific
  narrative detail genuinely requires direct citation, otherwise the
  named-but-flagged pattern (Ch23 FC-02 / Ch26 FC-02 precedent) applies for any
  scholar named in body prose without a sources.yaml entry.

variants:
  classification: co-equal
  summary: |
    Regional Mapuche variations across Nguluche, Huilliche, Pehuenche. The chapter presents
    the common narrative core while acknowledging regional variation, pending the
    ethnographic-source pinning at glossary-lock.

summary: |
  The marine serpent Kai-Kai raises the sea to drown the earth; the mountain serpent
  Tren-Tren raises the mountains in response to save the Mapuche. A two-serpent cosmogony
  that preserves a flood-and-height memory. The combat is between two serpent-beings rather
  than a single hero against a single monster; the pattern does not map cleanly onto
  chaoskampf.

cultural_relevance:
  centrality: |
    Central in Mapuche cosmogonic tradition; oral-tradition attestation recorded in
    19th-20th century ethnography.
  function: |
    - Cosmogonic (flood-and-height origins; geographic formation)
    - Aetiological (serpent-rivalry frames the elevated Mapuche landscape)
  cross_cultural_parallels: |
    - Two-serpent combat rather than hero-versus-serpent — structurally atypical.
    - Flood-and-height motif echoes flood narratives across Pacific Rim traditions
      (without implying transmission).

target_length_words: 2500

special_instructions: |
  Short family-style chapter (~2,500 narrative words). The five Mapuche anchors above are
  now pinned (sources.yaml commit pending), so the chapter can proceed with proper EVIDENCE
  tokens routed through Koessler-Ilg 1962 as the principal narrative anchor and Foerster /
  Bacigalupo / Course / Faron as area-specialist secondary anchors. Area-specialist
  citation policy applies: no comparative move precedes a specialist-sourced framing of
  the Mapuche material. The two-serpent structure (Kai-Kai and Tren-Tren both serpent-
  beings) means the chapter must note this atypicality relative to the book's hero-
  versus-monster default pattern — this is why the story is RELATED rather than CORE.

  Strong [APPROPRIATION-FLAG:] candidate per the Ch26 Pariacaca template: Mapuche-studies
  area specialists (Foerster, Bacigalupo, Course, Faron — and Latcham as precursor) read
  Kai-Kai / Tren-Tren as cosmogonic-cataclysm and ngillatun-ritual-foundation rather
  than as cosmos-versus-chaos combat. Register the named area specialists, the substance
  of the cosmogonic-cataclysm-rather-than-chaoskampf objection, the tier-implication
  clause, and the Ch40/Ch41 forwarding clause.

  Post-conquest filtering caveat applies (Diego de Rosales SJ ~1670; Núñez de Pineda
  y Bascuñán ~1673; later Latcham/Lenz/Augusta-Moesbach 1934-36 ethnographic compilations
  filtered through Spanish-language transcription). Register at chapter level with a
  [LACUNA] marker analogous to Ch24 / Ch26.
```
