...
_(The structural function of the Hesiodic Typhonomachy as the close of the succession-cycle gives the combat its royal-legitimation force, even though Hesiod does not explicitly say "Zeus's victory confirms his kingship".footnote:[Inference: the placement of the passage at Theog. 820–880 immediately before the catalogue of Zeus's marriages (894 ff.) and the wider succession-frame Ouranos-Kronos-Zeus, in which the Typhonomachy is the final combat that prevents a fourth-generation displacement. Risk: the inference is structural-narratological rather than directly attested; West's commentary endorses this reading without using these exact terms.])_
...
West 1966 reads Theog. 820–880 as a continuous and integral part of the _Theogony_.footnote:[An alternate tradition in 19th- and early-20th-century editorial scholarship treated the Typhonomachy as an interpolation by a later hand. The prevalent version is chosen here because the West 1966 reading is the modern scholarly consensus, and the lines are present in all principal manuscript witnesses; the interpolation hypothesis is no longer current.]
...
The Apollodoran narrative consolidates the volcanic-aetiological reading that had developed in the post-Hesiodic tradition. By the first or second century CE, the Etna identification has displaced the Hesiodic Tartarus locus as the canonical burial place of Typhon in many subsequent retellings.footnote:[Ogden 2013, ch. 2, on the consolidation of the Etna identification by the Apollodoran period.]
// EVIDENCE: source_id=ogden-2013 ; loc=ch. 2
...
_[Both witnesses are presented attributed to their own contexts: Apollodorus _Bibliotheca_ 1.6.3 (1st–2nd c. CE) gives the extended sinew-theft narrative, while Hesiod _Theogony_ 820–880 (c. 700 BCE) gives only the bare combat-and-burial sketch. The sinew-theft is registered as Apollodoran and is not retrojected into Hesiod.]_
...
_[Each witness is presented attributed to its own context, registering the millennium-long accretion of the narrative: Hesiod _Theogony_ 820–880 (c. 700 BCE) supplies the earliest sketch; Apollodorus _Bibliotheca_ 1.6.3 (1st–2nd c. CE) supplies the sinew-theft expansion; Nonnus _Dionysiaca_ 1–2 (5th c. CE) supplies the baroque elaboration with Cadmus's pipes; and the _Homeric Hymn to Apollo_ 305–355, Pindar _Pythian_ 1.16–28, and the Aeschylus-attributed _Prometheus Bound_ 351–372 supply partial attestations between them.]_
